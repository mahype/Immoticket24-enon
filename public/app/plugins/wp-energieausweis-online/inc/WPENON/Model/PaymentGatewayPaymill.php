  ...
  public function _displayForm() {
    ...
    <fieldset id="wpenon_sepa_fields">
      ...
      <p id="wpenon-sepa-account-holder-wrap">
        ...
        <input type="text" autocomplete="off" id="sepa_account_holder" class="sepa-account-holder edd-input required"<?php echo $enable_placeholders ? ' placeholder="' . __( 'Kontoinhaber', 'wpenon' ) . '"' : ''; ?>>
      </p>
      <p id="wpenon-sepa-account-id-wrap">
        ...
        <input type="text" autocomplete="off" id="sepa_account_id" class="sepa-account-id edd-input required"<?php echo $enable_placeholders ? ' placeholder="' . __( 'IBAN', 'wpenon' ) . '"' : ''; ?>>
      </p>
      <p id="wpenon-sepa-bank-id-wrap">
        ...
        <input type="text" autocomplete="off" id="sepa_bank_id" class="sepa-bank-id edd-input required"<?php echo $enable_placeholders ? ' placeholder="' . __( 'BIC', 'wpenon' ) . '"' : ''; ?>>
      </p>
      <p id="wpenon-sepa-bank-name-wrap" style="display:none;">
        ...
        <input type="text" autocomplete="off" id="sepa_bank_name" class="sepa-bank-name edd-input"<?php echo $enable_placeholders ? ' placeholder="' . __( 'Kreditinstitut', 'wpenon' ) . '"' : ''; ?> readonly disabled>
      </p>
    </fieldset>
    <?php
