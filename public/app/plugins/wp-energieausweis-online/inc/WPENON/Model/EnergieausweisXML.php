...
class EnergieausweisXML extends \WPENON\Util\XSDReader {
  ...
  public function getOccurrencesData( $min_occurs, $max_occurs, $path ) {
    if ( $this->energieausweis !== null ) {
      ...
      return call_user_func( 'wpenon_get_' . $this->standard . '_xml_' . $this->mode . '_data', $context, $index, $this->energieausweis, array( 'mode' => 'occurrences', 'min' => $min_occurs, 'max' => $max_occurs ) );
    }
    return false;
  }
  ...
  public function getAttributeData( $attribute, $path ) {
    if ( $this->energieausweis !== null ) {
      ...
      return call_user_func( 'wpenon_get_' . $this->standard . '_xml_' . $this->mode . '_data', $context, $index, $this->energieausweis, array( 'mode' => 'attribute', 'attribute' => $attribute ) );
    }
    return false;
  }
  ...
  public function getChoiceData( $choices, $path ) {
    if ( $this->energieausweis !== null ) {
      ...
      return call_user_func( 'wpenon_get_' . $this->standard . '_xml_' . $this->mode . '_data', $context, $index, $this->energieausweis, array( 'mode' => 'choice', 'choices' => $choices ) );
    }
    return false;
  }
  ...
  public function getValueData( $item, $path ) {
    if ( $this->energieausweis !== null ) {
      ...
      $value = call_user_func( 'wpenon_get_' . $this->standard . '_xml_' . $this->mode . '_data', $context, $index, $this->energieausweis, array( 'mode' => 'value', 'item' => $item ) );
      if ( $value === false ) {
