...
class Frontend
{
        ...
        switch ( $action ) {
          ...
          case 'purchase':
            ...
            if ( is_callable( array( $form, $function ) ) ) {
              $this->view = new \WPENON\View\FrontendBase( call_user_func( array( $form, $function ), $this->energieausweis ) );
  ...
  public function _enqueueScripts()
  {
    if( $this->enqueue_scripts )
    {
      ...
      wpenon_enqueue_script( 'wpenon-frontend', 'frontend', array_merge( $js_dependencies, array( 'jquery', 'wpenon-general' ) ) );
    }
  }
