      ...
      <td>
        ...
        <?php if ( ! empty( $item_url ) ) : ?>
          <div class="wpenon_purchase_receipt_link">
            <p style="font-size: 12px;"><a href="<?php echo esc_url( $item_url ); ?>"><?php _e( '(Zurück zum Energieausweis)', 'wpenon' ); ?></a></p>
          </div>
        <?php endif; ?>
    ...
    <fieldset id="edd_checkout_user_info">
      ...
      <?php foreach ( $fields as $field_slug => $field_title ) : ?>
        ...
        <p id="<?php echo $field_id; ?>-wrap">
          ...
          <input class="edd-input<?php if( edd_field_is_required( $field_slug ) ) { echo ' required'; } ?>" type="text" name="<?php echo $field_slug; ?>" id="<?php echo $field_id; ?>"<?php echo $enable_placeholders ? ' placeholder="' . $field_title . '"' : ''; ?> value="<?php echo $field_value; ?>"<?php echo 'email' == $field_shortslug ? ' readonly' : ''; ?>>
        </p>
        <?php
        if ( 'email' == $field_shortslug ) {
  ...
  public function _displayCCFormFields() {
    ...
    <fieldset id="edd_cc_fields" class="edd-do-validate">
      ...
      <p id="edd-card-number-wrap">
        ...
        <input type="text" autocomplete="off" name="card_number" id="card_number" class="card-number edd-input required"<?php echo $enable_placeholders ? ' placeholder="' . __( 'Card number', 'easy-digital-downloads' ) . '"' : ''; ?> />
      </p>
      <p id="edd-card-cvc-wrap">
        ...
        <input type="text" size="4" maxlength="4" autocomplete="off" name="card_cvc" id="card_cvc" class="card-cvc edd-input required"<?php echo $enable_placeholders ? ' placeholder="' . __( 'Security code', 'easy-digital-downloads' ) . '"' : ''; ?> />
      </p>
      <p id="edd-card-name-wrap">
        ...
        <input type="text" autocomplete="off" name="card_name" id="card_name" class="card-name edd-input required"<?php echo $enable_placeholders ? ' placeholder="' . __( 'Card name', 'easy-digital-downloads' ) . '"' : ''; ?> />
      </p>
  ...
  public function _displayCCAddressFields() {
    ...
    <fieldset id="edd_cc_address" class="cc-address">
      ...
      <p id="edd-card-address-wrap">
        ...
        <input type="text" id="card_address" name="card_address" class="card-address edd-input<?php if( edd_field_is_required( 'card_address' ) ) { echo ' required'; } ?>"<?php echo $enable_placeholders ? ' placeholder="' . __( 'Address line 1', 'easy-digital-downloads' ) . '"' : ''; ?> value="<?php echo $line1; ?>"/>
      </p>
      <p id="edd-card-address-2-wrap">
        ...
        <input type="text" id="card_address_2" name="card_address_2" class="card-address-2 edd-input<?php if( edd_field_is_required( 'card_address_2' ) ) { echo ' required'; } ?>"<?php echo $enable_placeholders ? ' placeholder="' . __( 'Address line 2', 'easy-digital-downloads' ) . '"' : ''; ?> value="<?php echo $line2; ?>"/>
      </p>
      <p id="edd-card-zip-wrap">
        ...
        <input type="text" size="4" name="card_zip" class="card-zip edd-input<?php if( edd_field_is_required( 'card_zip' ) ) { echo ' required'; } ?>"<?php echo $enable_placeholders ? ' placeholder="' . __( 'Zip / Postal code', 'easy-digital-downloads' ) . '"' : ''; ?> value="<?php echo $zip; ?>"/>
      </p>
      <p id="edd-card-city-wrap">
        ...
        <input type="text" id="card_city" name="card_city" class="card-city edd-input<?php if( edd_field_is_required( 'card_city' ) ) { echo ' required'; } ?>"<?php echo $enable_placeholders ? ' placeholder="' . __( 'City', 'easy-digital-downloads' ) . '"' : ''; ?> value="<?php echo $city; ?>"/>
      </p>
      ...
      <p id="edd-card-state-wrap">
        ...
        <span class="edd-description"><?php _e( 'The state or province for your billing address.', 'easy-digital-downloads' ); ?></span>
          ...
          $selected_state = $user_address['state'];
            ...
            <?php else : ?>
        <input type="text" size="6" name="card_state" id="card_state" class="card_state edd-input"<?php echo $enable_placeholders ? ' placeholder="' . __( 'State / Province', 'easy-digital-downloads' ) . '"' : ''; ?> />
        <?php endif; ?>
      </p>
      ...
      <tr>
        ...
        <td>
          ...
          <?php foreach ( $types as $value => $label ) : ?>
            <option value="<?php echo $value; ?>" <?php selected( $discount_type, $value ); ?>><?php echo $label; ?></option>
          <?php endforeach; ?>
          </select>
