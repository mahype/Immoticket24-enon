        ...
        <?php else : ?>
          <?php switch ($field['type']):
            ...
            case 'int': ?>
              ...
              <input type="number" step="1" id="<?php echo $field_slug; ?>" name="<?php echo $field_slug; ?>" class="form-control int-control" value="<?php echo $field['value']; ?>" step="1" <?php echo ($field['min'] !== false ? ' min="' . $field['min'] . '"' : '') . ($field['max'] !== false ? ' max="' . $field['max'] . '"' : '') . ($field['readonly'] ? ' readonly' : '') . ($field['required'] ? ' required' : ''); ?>>
            ...
            case 'image': ?>
              ...
              <div id="<?php echo $field_slug; ?>_notice" class="field-notice" style="display:none; border: 2px solid red; background-color: white; padding:5px; margin-bottom:10px;"></div>
