...
class Error extends WP_Error {
	...
	public function __call( $method_name, $arguments ) {
		if ( ! $this->error_handled ) {
			...
			$this->handle_error( sprintf( __( 'After the error occurred, it was tried to call method %s on the unhandled error object.', 'enon' ), '<code>' . $method_name . '()</code>' ) );
	...
	public function __get( $property ) {
		if ( ! $this->error_handled ) {
			...
			$this->handle_error( sprintf( __( 'After the error occurred, it was tried to access property %s on the unhandled error object.', 'enon' ), '<code>$' . $property . '</code>' ) );
