...
var op_asset_settings = (function ($) {
    ...
    var style_has_pricing_description = ['4', '5', '6', '7', '8', '10'];
    var style_has_package_description = ['1', '2', '3', '4', '5', '6', '7', '8', '10'];
    var style_has_feature_description = ['4', '5', '6', '7', '8'];
    var style_has_button_color_picker = ['9', '11'];
    var style_has_price_color_picker  = ['9'];
    var style_has_color_picker        = ['10'];
    ...
    return {
        ...
        attributes: {
                ...
                style: {
                    ...
                    events: {
                        change: function(value, steps) {
                            /**
                             * We are hiding most popular text input for styles 1 and 2
                             * to avoid customer confusion
                             */
                            var most_popular_checkboxes = steps[1].find("input[id$='_most_popular']");

                            if (value > '2' || value != '9') {
                                $.each(most_popular_checkboxes, function() {
                                    var input = $(this).parent().parent().next();
                                    if ($(this).is(':checked')) input.show();
                                    else input.hide();
                                });
                            } else {
                                 $.each(most_popular_checkboxes, function() {
            ...
            step_2: {
                button_color: {
                    title: 'pricing_table_button_color',
                    type: 'color',
                    default_value: '#1ec9a7',
                    showOn: {
                        field: 'step_1.style',
                        value: style_has_button_color_picker,
                        idprefix: 'op_assets_core_pricing_table_',
                    }
                },
                price_color: {
                    title: 'pricing_table_price_color',
                    type: 'color',
                    default_value: '#16a086',
                    showOn: {
                        field: 'step_1.style',
                        value: style_has_price_color_picker,
                        idprefix: 'op_assets_core_pricing_table_',
                    }
                },
                children: {
                    ...
                    multirow: {
                        ...
                        attributes: {
                            ...
                            table_color: {
                                title: 'pricing_table_color_picker',
                                type: 'color',
                                default_value: '#16a086',
                                showOn: {
                                    field: 'step_1.style',
                                    value: style_has_color_picker,
                                    idprefix: 'op_assets_core_pricing_table_',
                                }
                            },
                            title: {
                            ...
                            pricing_description: {
                                ...
                                showOn: {
                                    field: 'step_1.style',
                                    value: style_has_pricing_description,
                                    idprefix: 'op_assets_core_pricing_table_',
                                }
                            },
                            order_button_text: {
                            ...
                            package_description: {
                                ...
                                showOn: {
                                    field: 'step_1.style',
                                    value: style_has_package_description,
                                    idprefix: 'op_assets_core_pricing_table_',
                                }
                            },
                            most_popular: {
                                ...
                                events: {
                                    ...
                                    change: function() {
                                        var style = $('#op_assets_core_pricing_table_style_container .op-asset-dropdown-list').find('.selected img').attr('alt');

                                        if (style == '1' || style == '2' || style == '9') {
                                            return;
                                        }
                            ...
                            feature_description: {
                                ...
                                showOn: {
                                    field: 'step_1.style',
                                    value: style_has_feature_description,
                                    idprefix: 'op_assets_core_pricing_table_',
                                }
                            },
                            items: {
        ...
        customInsert: function (attrs) {
            var result = '',
                ...
                style = (attrs.style || 1),
                button_color = (attrs.button_color),
                price_color = (attrs.price_color);
                table_color = (attrs.table_color);
            ...
            for (var i = 0; i < children.length; i++) {
                ...
                result += ''
                    ...
                    + ' pricing_description="' + encodeURIComponent(children[i].pricing_description || '') + '"'
                    ...
                    + ' feature_description="' + encodeURIComponent(children[i].feature_description || '') + '"'
                    + ' items="' + (children[i].items || '') + '"'
                    + ' table_color="' + encodeURIComponent(children[i].table_color || '') + '"'
                    + ']'
                    + '[/op_pricing_table_child]';
            }
            ;
            ...
            // wrap shortcode
            result = '[op_pricing_table style="' + style + '" button_color="' + button_color + '" price_color="' + price_color + '"]' + result + '[/op_pricing_table]';
            //result = '[op_pricing_table style="' + style + '"]' + result + '[/op_pricing_table]';
        ...
        customSettings: function (attrs, steps) {
            ...
            if ($.inArray(style, style_has_button_color_picker)) {
                $('#op_assets_core_pricing_table_button_color').val(attrs.attrs.button_color || '').trigger('change');
                $('#op_assets_core_pricing_table_price_color').val(attrs.attrs.price_color || '').trigger('change');
            }
            ...
            for (var i = 0; i < children.length; i++) {
                ...
                input.filter('[id$="_table_color"]').val(op_decodeURIComponent(value.table_color || '')).trigger('change');
