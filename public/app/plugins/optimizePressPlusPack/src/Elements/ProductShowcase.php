...
class Oppp_Elements_Product_Showcase
{
    ...
    public function parentShortcode($atts, $content)
    {
        ...
        if (OP_SCRIPT_DEBUG === '') {
            ...
            wp_enqueue_style(OP_SN.'-addon-product-showcase', OPPP_BASE_URL . 'css/elements/op_product_showcase' . OP_SCRIPT_DEBUG . '.css', array(OP_SN.'-flexslider'), OPPP_VERSION, 'all');
        }
