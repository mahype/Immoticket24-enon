<?php include 'child_style.inc.php'; ?>

<div id="<?php echo $tableId; ?>" class="pricing-table-column<?php echo (!empty($most_popular_text) && $most_popular=='Y' ? ' popular' : ''); ?>">
    <div class="pricing-table-column-content">
        
        <?php if($most_popular == 'Y') { ?>
            <div class="popular"><span><?php echo $most_popular_text; ?></span></div>
        <?php } ?>
