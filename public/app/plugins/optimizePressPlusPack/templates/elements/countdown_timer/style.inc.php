    ...
    switch($font) {
        case 'open_sans':
                if (!isset($custom_font_loaded['open_sans'])) {
                    $font_string = '@import url("//fonts.googleapis.com/css?family=Open+Sans:700,600,400");';
            ...
            case 'open_sans_condensed':
                if (!isset($custom_font_loaded['open_sans_condensed'])) {
                    $font_string = '@import url("//fonts.googleapis.com/css?family=Open+Sans+Condensed:300,700|Open+Sans:700,300,400");';
            ...
            case 'montserrat':
                if (!isset($custom_font_loaded['montserrat'])) {
                    $font_string = '@import url("//fonts.googleapis.com/css?family=Montserrat:400,700");';
            ...
            case 'signika':
                if (!isset($custom_font_loaded['signika'])) {
                    $font_string = '@import url("//fonts.googleapis.com/css?family=Signika+Negative:400,600,300,700");';
            ...
            case 'roboto':
                if (!isset($custom_font_loaded['roboto'])) {
                    $font_string = '@import url("//fonts.googleapis.com/css?family=Roboto+Slab:400,700");';
            ...
            case 'play':
                if (!isset($custom_font_loaded['play'])) {
                    $font_string = '@import url("//fonts.googleapis.com/css?family=Play:400,700");';
