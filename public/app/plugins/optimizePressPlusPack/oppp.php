...
class Oppp
{
    ...
    private function __construct()
    {
        ...
        add_action('wp_footer', array($this, 'enqueueFrontendScripts'));
        add_action('admin_footer', array($this, 'enqueueFrontendScripts'));
    ...
    protected function loadElements()
    {
        ...
        require_once 'src/Elements/ScrollToTop.php';
        require_once 'src/Elements/Map.php';
