...
add_action('init', function (){
	...
	$cunks = (int) !empty($_GET['wpenon_image_cleanup_chunks']) ? $_GET['wpenon_image_cleanup_chunks'] : get_cunk_size($item_count);
	...
	$query_args = [
		'wpenon_image_cleanup_progress' => $is_runing,
...
function get_cunk_size ($item_count){
	$chunk_size = 500;
