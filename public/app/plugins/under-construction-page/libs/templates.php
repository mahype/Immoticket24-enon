  ...
  static function admin_enqueue_scripts($hook) {
    ...
    if('posts_page_ucp_editor' == $hook) {
      ...
      $ucp_editor_variables = array(
        ...
        'ucp_bunny_fonts' => self::bunny_fonts(),
  ...
  static function display_template($template = false){
    ...
    <?php
      if($template_data){
        ...
        $template_html = str_replace('fonts.googleapis.com', 'fonts.bunny.net', $template_html);
