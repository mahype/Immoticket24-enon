...
?>
												...
												<p style="text-align: center; margin-top: 20px; font-size: 15px; color: #a09e9e">
													<small>
														<?php // Translators: %s is the link to the admin page where the setting is. ?>
														<?php echo wp_kses_post( sprintf(
															...
															esc_url( home_url() ),
															get_bloginfo( 'name' ),
															admin_url( 'admin.php?page=affiliate-wp-settings&tab=misc#disable_monthly_email_summaries' )
														) ); ?>
													</small>
												</p>
										</td>
