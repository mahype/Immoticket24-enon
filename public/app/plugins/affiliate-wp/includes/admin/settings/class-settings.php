	...
	public function get_settings( array $filter_by = array() ) : array {
		...
		$settings = array(
			...
			'flat_rate_basis' => array(
				...
				'class'   => affiliate_wp()->settings->get( 'referral_rate_type', 'percentage' ) === 'percentage'
					? 'affwp-referral-rate-type-field affwp-hidden'
					: 'affwp-referral-rate-type-field',
				'std'     => 'per_product',
				'visibility' => array(
					'required_field' => 'referral_rate_type',
					'value'          => 'flat',
				),
			),
			'referral_rate' => array(
