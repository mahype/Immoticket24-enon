...
define('BORLABS_COOKIE_VERSION', '3.0.0.4');
define('BORLABS_COOKIE_BUILD', '231031');
...
if (!class_exists('Twig')) {
    \Borlabs\Autoloader::getInstance()->addNamespace(
        'Twig',
        BORLABS_COOKIE_PLUGIN_PATH . '/vendor/twig/twig/src'
    );
}
...
if (!class_exists('GeoIp2')) {
    \Borlabs\Autoloader::getInstance()->addNamespace(
        'GeoIp2',
        BORLABS_COOKIE_PLUGIN_PATH . '/vendor/geoip2/geoip2/src'
    );
    \Borlabs\Autoloader::getInstance()->addNamespace(
        'MaxMind\\Db',
        BORLABS_COOKIE_PLUGIN_PATH . '/vendor/maxmind-db/reader/src/MaxMind/Db'
    );
}
