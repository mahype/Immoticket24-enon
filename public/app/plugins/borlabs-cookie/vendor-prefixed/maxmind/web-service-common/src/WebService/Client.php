...
namespace Borlabs\Cookie\Dependencies\MaxMind\WebService;

use Borlabs\Cookie\Dependencies\Composer\CaBundle\CaBundle;
use Borlabs\Cookie\Dependencies\MaxMind\Exception\AuthenticationException;
use Borlabs\Cookie\Dependencies\MaxMind\Exception\HttpException;
use Borlabs\Cookie\Dependencies\MaxMind\Exception\InsufficientFundsException;
use Borlabs\Cookie\Dependencies\MaxMind\Exception\InvalidInputException;
use Borlabs\Cookie\Dependencies\MaxMind\Exception\InvalidRequestException;
use Borlabs\Cookie\Dependencies\MaxMind\Exception\IpAddressNotFoundException;
use Borlabs\Cookie\Dependencies\MaxMind\Exception\PermissionRequiredException;
use Borlabs\Cookie\Dependencies\MaxMind\Exception\WebServiceException;
use Borlabs\Cookie\Dependencies\MaxMind\WebService\Http\RequestFactory;
