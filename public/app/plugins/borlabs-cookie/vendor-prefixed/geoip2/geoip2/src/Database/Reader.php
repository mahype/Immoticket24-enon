...
namespace Borlabs\Cookie\Dependencies\GeoIp2\Database;

use Borlabs\Cookie\Dependencies\GeoIp2\Exception\AddressNotFoundException;
use Borlabs\Cookie\Dependencies\GeoIp2\Model\AbstractModel;
use Borlabs\Cookie\Dependencies\GeoIp2\Model\AnonymousIp;
use Borlabs\Cookie\Dependencies\GeoIp2\Model\Asn;
use Borlabs\Cookie\Dependencies\GeoIp2\Model\City;
use Borlabs\Cookie\Dependencies\GeoIp2\Model\ConnectionType;
use Borlabs\Cookie\Dependencies\GeoIp2\Model\Country;
use Borlabs\Cookie\Dependencies\GeoIp2\Model\Domain;
use Borlabs\Cookie\Dependencies\GeoIp2\Model\Enterprise;
use Borlabs\Cookie\Dependencies\GeoIp2\Model\Isp;
use Borlabs\Cookie\Dependencies\GeoIp2\ProviderInterface;
use Borlabs\Cookie\Dependencies\MaxMind\Db\Reader as DbReader;
...
class Reader implements ProviderInterface
{
     ...
     *
     * @throws \Borlabs\Cookie\Dependencies\MaxMind\Db\Reader\InvalidDatabaseException if the database
     ...
     *
     * @throws \Borlabs\Cookie\Dependencies\GeoIp2\Exception\AddressNotFoundException  if the address is
     *                                                     not in the database
     * @throws \Borlabs\Cookie\Dependencies\MaxMind\Db\Reader\InvalidDatabaseException if the database
     *                                                     is corrupt or invalid
     */
     ...
     *
     * @return \Borlabs\Cookie\Dependencies\MaxMind\Db\Reader\Metadata object for the database
     */
