...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler
                ->write("use Borlabs\Cookie\Dependencies\Twig\Environment;\n")
                ->write("use Borlabs\Cookie\Dependencies\Twig\Error\LoaderError;\n")
                ->write("use Borlabs\Cookie\Dependencies\Twig\Error\RuntimeError;\n")
                ->write("use Borlabs\Cookie\Dependencies\Twig\Extension\SandboxExtension;\n")
                ->write("use Borlabs\Cookie\Dependencies\Twig\Markup;\n")
                ->write("use Borlabs\Cookie\Dependencies\Twig\Sandbox\SecurityError;\n")
                ->write("use Borlabs\Cookie\Dependencies\Twig\Sandbox\SecurityNotAllowedTagError;\n")
                ->write("use Borlabs\Cookie\Dependencies\Twig\Sandbox\SecurityNotAllowedFilterError;\n")
                ->write("use Borlabs\Cookie\Dependencies\Twig\Sandbox\SecurityNotAllowedFunctionError;\n")
                ->write("use Borlabs\Cookie\Dependencies\Twig\Source;\n")
                ->write("use Borlabs\Cookie\Dependencies\Twig\Template;\n\n")
            ;
        }
        $compiler
