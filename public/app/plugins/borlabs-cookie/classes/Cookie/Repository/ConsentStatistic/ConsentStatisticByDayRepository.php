...
/**
 * @extends AbstractRepository<ConsentStatisticByDayEntryModel>
 */
class ConsentStatisticByDayRepository extends AbstractRepository implements RepositoryInterface
{
    public const MODEL = ConsentStatisticByDayEntryModel::class;

    public const TABLE = 'borlabs_cookie_consent_statistic_by_day';
    ...
    public function insertOrIncrementCount(ConsentStatisticByDayEntryModel $model): AbstractModel
    {
