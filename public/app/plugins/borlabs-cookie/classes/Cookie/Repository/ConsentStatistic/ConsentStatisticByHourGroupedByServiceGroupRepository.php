...
/**
 * @extends AbstractRepository<ConsentStatisticByHourGroupedByServiceGroupEntryModel>
 *
 * @mixin StatisticRepositoryMethodsTrait<ConsentStatisticByHourGroupedByServiceGroupEntryModel>
 */
class ConsentStatisticByHourGroupedByServiceGroupRepository extends AbstractRepository implements RepositoryInterface
{
    use StatisticRepositoryMethodsTrait;

    public const MODEL = ConsentStatisticByHourGroupedByServiceGroupEntryModel::class;
