...
/**
 * @extends AbstractRepository<ConsentStatisticByDayGroupedByServiceGroupEntryModel>
 *
 * @mixin StatisticRepositoryMethodsTrait<ConsentStatisticByDayGroupedByServiceGroupEntryModel>
 */
final class ConsentStatisticByDayGroupedByServiceGroupRepository extends AbstractRepository implements RepositoryInterface
{
    use StatisticRepositoryMethodsTrait;

    public const MODEL = ConsentStatisticByDayGroupedByServiceGroupEntryModel::class;

    public const TABLE = 'borlabs_cookie_consent_stats_day_grp';
