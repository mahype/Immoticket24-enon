...
final class ConsentLogRepository extends AbstractRepository implements RepositoryInterface
{
    ...
    private function hasIdenticalConsents(ConsentLogModel $currentConsent, ?ConsentLogModel $latestConsent = null)
    {
        return isset($latestConsent) && $latestConsent->consents == $currentConsent->consents;
    }

    private function hasIdenticalIabTcfTcString(ConsentLogModel $currentConsent, ?ConsentLogModel $latestConsent = null)
    {
