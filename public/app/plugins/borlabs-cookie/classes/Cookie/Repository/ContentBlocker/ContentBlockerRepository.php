...
use Borlabs\Cookie\Exception\System\ContentBlockerException;
...
final class ContentBlockerRepository extends AbstractRepositoryWithLanguage implements RepositoryInterface
{
     ...
     * @throws \Borlabs\Cookie\Exception\System\ContentBlockerException
     */
    public function deleteWithRelations(int $id): void
    {
        ...
        if ($contentBlocker->contentBlockerLocations !== null) {
            foreach ($contentBlocker->contentBlockerLocations as $contentBlockerLocation) {
                ...
                if ($result !== 1) {
                    throw new ContentBlockerException('deletingContentBlockerLocationFailed');
                }
            }
        }
        ...
        if ($result !== 1) {
            throw new ContentBlockerException('deletingContentBlockerFailed');
        }
    }
