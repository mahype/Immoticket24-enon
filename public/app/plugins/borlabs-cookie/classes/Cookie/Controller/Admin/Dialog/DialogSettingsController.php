...
final class DialogSettingsController implements ControllerInterface, ExtendedRouteValidationInterface
{
    ...
    public function save(array $postData): string
    {
        ...
        $dialogSettingsConfig->showDialog = (bool) $postData['showDialog'];
        $dialogSettingsConfig->showDialogOnLoginPage = (bool) $postData['showDialogOnLoginPage'];
        $dialogSettingsConfig->enableBackdrop = (bool) $postData['enableBackdrop'];
        $dialogSettingsConfig->showBorlabsCookieBranding = (bool) $postData['showBorlabsCookieBranding'];
        // Basic Dialog Settings
        $dialogSettingsConfig->layout = (string) $postData['layout'];
        $dialogSettingsConfig->position = (string) $postData['position'];
        $dialogSettingsConfig->serviceGroupJustification = (string) $postData['serviceGroupJustification'];
        $dialogSettingsConfig->showAcceptAllButton = (bool) $postData['showAcceptAllButton'];
        $dialogSettingsConfig->showAcceptOnlyEssentialButton = (bool) $postData['showAcceptOnlyEssentialButton'];
        $dialogSettingsConfig->showHeadlineSeparator = (bool) $postData['showHeadlineSeparator'];
        $dialogSettingsConfig->buttonSwitchRound = (bool) $postData['buttonSwitchRound'];
        ...
        // The settings for `showAcceptAllButton` and `showAcceptOnlyEssentialButton` must be set before calling this method
        $dialogSettingsConfig->buttonDetailsOrder = $this->placeDisabledButtonsAtTheEnd($dialogSettingsConfig->buttonDetailsOrder, $dialogSettingsConfig);
        $dialogSettingsConfig->buttonEntranceOrder = $this->placeDisabledButtonsAtTheEnd($dialogSettingsConfig->buttonEntranceOrder, $dialogSettingsConfig);

        // Animation Settings
        $dialogSettingsConfig->animation = (bool) $postData['animation'];
        $dialogSettingsConfig->animationDelay = (bool) $postData['animationDelay'];
        $dialogSettingsConfig->animationIn = (string) $postData['animationIn'];
        $dialogSettingsConfig->animationOut = (string) $postData['animationOut'];
        // Logo Settings
        $dialogSettingsConfig->showLogo = (bool) $postData['showLogo'];
        $dialogSettingsConfig->logo = (string) $postData['logo'];
        $dialogSettingsConfig->logoHd = (string) $postData['logoHd'];
        // Privacy URL
        ...
        $dialogSettingsConfig->geoIpActive = (bool) $postData['geoIpActive'];
        $dialogSettingsConfig->geoIpCachingMode = (bool) $postData['geoIpCachingMode'];
    ...
    private function placeDisabledButtonsAtTheEnd(array $buttonOrder, DialogSettingsDto $dialogSettingsConfig): array
    {
        $newOrder = [];
        $disabledButtons = [];
