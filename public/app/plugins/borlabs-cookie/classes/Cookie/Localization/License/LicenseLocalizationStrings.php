    ...
    public static function get(): array
    {
        return [
            ...
            'alert' => [
                ...
                'invalidSiteData' => _x(
                    'Your site data is not valid. To remove the license key, please use our customer portal. <a href="https://service.borlabs.io/" rel="nofollow noreferrer" target="_blank">service.borlabs.io</a>.',
                    'Backend / License / Alert Message',
                    'borlabs-cookie',
                ),
                'licenseBlockedDomain' => _x(
                    'The license key has been blocked for this domain. Check your license key in our customer portal <a href="https://service.borlabs.io/" rel="nofollow noreferrer" target="_blank">service.borlabs.io</a>.',
                    'Backend / License / Alert Message',
                    'borlabs-cookie',
                ),
                'licenseExpired' => _x(
                    'Please renew your license key to receive updates. <a href="https://service.borlabs.io/" target="_blank" rel="nofollow noreferrer">Click here</a> to log into your account and purchase a license renewal.',
                    'Backend / License / Alert Message',
                    'borlabs-cookie',
                ),
                'licenseNotValidForCurrentBuild' => _x(
                    'Your license key is not valid for this version. This version of Borlabs Cookie was released after your license has expired, therefore you have to <a href="https://service.borlabs.io/" rel="nofollow noreferrer" target="_blank">click here</a> to log into your account and purchase a license renewal.',
                    'Backend / License / Alert Message',
                    'borlabs-cookie',
                ),
                'licenseQuotaExceeded' => _x(
                    'It is not possible to register another website with this license key. Remove the license key from another website to register it here. Check your license key in our customer portal <a href="https://service.borlabs.io/" rel="nofollow noreferrer" target="_blank">service.borlabs.io</a>.',
                    'Backend / License / Alert Message',
                    'borlabs-cookie',
                ),
                ...
                'validLicenseRequired' => _x(
                    'A valid license is required to use this feature of Borlabs Cookie. <a href="?page=borlabs-cookie-license">Click here</a> to enter your license key, or <a href="https://service.borlabs.io/" rel="nofollow noreferrer" target="_blank">click here</a> to log into your account and purchase a license renewal.',
                    'Backend / License / Alert Message',
                    'borlabs-cookie',
                ),
            ],
            ...
            'thingsToKnow' => [
                ...
                'transferringLicenseKeyToNewWebsiteA' => _x(
                    'You can use the <translation-key id="Remove-License">Remove License</translation-key> option to remove the license from this website or you visit our <translation-key id="Customer-Portal">Customer Portal</translation-key> and remove the license from there.',
