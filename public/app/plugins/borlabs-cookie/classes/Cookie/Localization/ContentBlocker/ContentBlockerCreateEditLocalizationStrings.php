    ...
    public static function get(): array
    {
        return [
            ...
            'hint' => [
                ...
                'status' => _x(
                    'The status of this <translation-key id="Content-Blocker">Content Blocker</translation-key>. If enabled (Status: ON) it does block content (iframes) of the configured <translation-key id="Locations">Locations</translation-key>.',
                    'Backend / Content Blockers / Hint',
                    'borlabs-cookie',
                ),
            ],
