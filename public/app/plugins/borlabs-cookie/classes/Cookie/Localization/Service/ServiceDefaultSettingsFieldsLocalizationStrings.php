    ...
    public static function get(): array
    {
        return [
            ...
            'hint' => [
                ...
                'block-cookies-before-consent' => _x(
                    'If enabled (Status: ON) <translation-key id="Borlabs-Cookie">Borlabs Cookie</translation-key> tries to block cookies with the names from <translation-key id="Cookie-Name">Cookie Name</translation-key> until consent is given.',
                    'Backend / Services / Hint',
                    'borlabs-cookie',
                ),
                'prioritize' => _x(
