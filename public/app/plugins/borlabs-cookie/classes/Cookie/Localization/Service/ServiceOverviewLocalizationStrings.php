    ...
    public static function get(): array
    {
        return [
            ...
            'alert' => [
                ...
                'deletingServiceCookieFailed' => _x(
                    'Deleting a Service Cookie failed.',
                    'Backend / Services / Alert Message',
                    'borlabs-cookie',
                ),
                'deletingServiceLocationFailed' => _x(
                    'Deleting a Service Cookie failed.',
                    'Backend / Services / Alert Message',
                    'borlabs-cookie',
                ),
                'deletingServiceOptionFailed' => _x(
                    'Deleting a Service Option failed.',
                    'Backend / Services / Alert Message',
                    'borlabs-cookie',
                ),
                'deletingServiceFailed' => _x(
                    'Deleting a Service failed.',
                    'Backend / Services / Alert Message',
                    'borlabs-cookie',
                ),
            ],
