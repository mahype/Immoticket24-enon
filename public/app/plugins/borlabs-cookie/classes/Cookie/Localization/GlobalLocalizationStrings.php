    ...
    public static function get(): array
    {
        return [
            ...
            'alert' => [
                ...
                'modelStillInUse' => _x(
                    'The {{ modelName }} "{{ modelLabel }}" is still in use by the {{ blockingModelName }} "{{ blockingModelLabel }}".',
                    'Backend / Global / Alert Message',
                    'borlabs-cookie',
                ),
            ...
            'hint' => [
                ...
                'languages' => _x(
                    'Create this entry also for other languages. This option is only available when a new entry is created.',
                    'Backend / Global / Hint',
                    'borlabs-cookie',
                ),
            ],
