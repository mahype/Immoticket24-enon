        ...
        return [
            ...
            'field' => [
                ...
                'iabTcfHeadlineSpecialFeatures' => _x(
                    'Special Features - Headline',
                    'Backend / IAB TCF Cookie Box / Headline',
                    'borlabs-cookie',
                ),
                'iabTcfHeadlineSpecialPurposes' => _x(
                    'Special Purposes - Headline',
                    'Backend / IAB TCF Cookie Box / Headline',
                    'borlabs-cookie',
                ),
                ...
                'serviceDetailsTableServiceOptionLocationProcessing' => _x(
                    'Service Option - Location Processing',
                    'Backend / Dialog Localization / Table Headline',
                    'borlabs-cookie',
                ),
