    ...
    public static function get(): array
    {
        return [
            ...
            'alert' => [
                ...
                'possibleLawViolationSetting' => _x(
            ...
            'hint' => [
                ...
                'animationDelay' => _x(
                    'If enabled, the <translation-key id="Animation">Animation</translation-key> and <translation-key id="Appearance">Appearance</translation-key> of the <translation-key id="Dialog">Dialog</translation-key> is delayed for two seconds.',
                    'Backend / Dialog Settings / Hint',
                    'borlabs-cookie',
                ),
                'animationIn' => _x(
            ...
            'thingsToKnow' => [
                ...
                'howToChangeConsentE' => _x(
                    'The CSS class cannot be used on a &lt;a&gt; tag, because the tag with the CSS class gets a &lt;a&gt; tag inserted by <translation-key id="Borlabs-Cookie">Borlabs Cookie</translation-key>.',
                    'Backend / Dialog Settings / Things to know / Text',
                    'borlabs-cookie',
                ),
