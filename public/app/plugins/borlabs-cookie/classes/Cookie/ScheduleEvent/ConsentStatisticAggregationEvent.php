...
final class ConsentStatisticAggregationEvent implements ScheduleEventInterface
{
    ...
    public function __construct(ConsentStatisticService $consentStatisticService)
    {
    ...
    public function register(): void
    {
        ...
        if (!wp_next_scheduled(ScheduleEventManager::EVENT_PREFIX . self::EVENT_NAME)) {
            wp_schedule_event(time(), 'hourly', ScheduleEventManager::EVENT_PREFIX . self::EVENT_NAME);
        }
    }
