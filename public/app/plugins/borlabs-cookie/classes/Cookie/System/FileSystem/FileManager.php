...
final class FileManager
{
    ...
    /**
     * @var \Borlabs\Cookie\System\FileSystem\GlobalCacheFolder
     */
    private GlobalCacheFolder $globalCacheFolder;

    /**
     * @var \Borlabs\Cookie\System\FileSystem\GlobalStorageFolder
     */
    ...
    {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $externalFileDto->url);
        ...
        return $this->saveFile($fileName, $fileContent, $location, $computedChecksum);
    }
