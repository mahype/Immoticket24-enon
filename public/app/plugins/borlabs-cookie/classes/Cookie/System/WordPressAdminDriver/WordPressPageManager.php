...
final class WordPressPageManager
{
    ...
    private function registerBorlabsCookieMenu(): void
    {
        $this->wpFunction->addMenuPage(
            ...
            $this->wordPressPageManagerLocalizationStrings->get()['menuTitle']['borlabsCookie'],
            self::CAPABILITY,
    ...
    private function registerSubMenuConsentManagement(): void
    {
        ...
        $this->wpFunction->addSubMenuPage(
            $this->mainMenuSlug,
            $this->wordPressPageManagerLocalizationStrings->get()['siteTitle']['provider'],
            $this->wordPressPageManagerLocalizationStrings->get()['menuTitle']['provider'],
            self::CAPABILITY,
    ...
    private function registerSubMenuContentBlocker(): void
    {
        $this->wpFunction->addSubMenuPage(
            $this->mainMenuSlug,
            $this->wordPressPageManagerLocalizationStrings->get()['siteTitle']['contentBlocker'],
            $this->wordPressPageManagerLocalizationStrings->get()['menuTitle']['contentBlocker'],
            self::CAPABILITY,
        ...
        $this->wpFunction->addSubMenuPage(
            $this->mainMenuSlug,
            $this->wordPressPageManagerLocalizationStrings->get()['siteTitle']['contentBlockerManage'],
            $this->wordPressPageManagerLocalizationStrings->get()['menuTitle']['contentBlockerManage'],
            self::CAPABILITY,
            ContentBlockerController::CONTROLLER_ID,
            [$this->wordPressControllerBridge, ContentBlockerController::class],
        );
        $this->wpFunction->addSubMenuPage(
            $this->mainMenuSlug,
            $this->wordPressPageManagerLocalizationStrings->get()['siteTitle']['contentBlockerSettings'],
            $this->wordPressPageManagerLocalizationStrings->get()['menuTitle']['contentBlockerSettings'],
            self::CAPABILITY,
        ...
        $this->wpFunction->addSubMenuPage(
            $this->mainMenuSlug,
            $this->wordPressPageManagerLocalizationStrings->get()['siteTitle']['contentBlockerAppearance'],
            $this->wordPressPageManagerLocalizationStrings->get()['menuTitle']['contentBlockerAppearance'],
            self::CAPABILITY,
    ...
    private function registerSubMenuScriptBlocker(): void
    {
        $this->wpFunction->addSubMenuPage(
            $this->mainMenuSlug,
            $this->wordPressPageManagerLocalizationStrings->get()['siteTitle']['scriptBlocker'],
            $this->wordPressPageManagerLocalizationStrings->get()['menuTitle']['scriptBlocker'],
            self::CAPABILITY,
    ...
    private function registerSubMenuStyleBlocker(): void
    {
        $this->wpFunction->addSubMenuPage(
            $this->mainMenuSlug,
            $this->wordPressPageManagerLocalizationStrings->get()['siteTitle']['styleBlocker'],
            $this->wordPressPageManagerLocalizationStrings->get()['menuTitle']['styleBlocker'],
            self::CAPABILITY,
