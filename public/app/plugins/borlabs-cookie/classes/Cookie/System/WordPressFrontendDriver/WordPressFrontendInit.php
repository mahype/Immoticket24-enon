...
final class WordPressFrontendInit
{
    ...
    public function register(): void
    {
        ...
        if (
            ...
            // Register resources
            $this->wpFunction->addAction($this->wpFunction->hasAction('print_import_map') ? 'after_setup_theme' : 'wp_enqueue_scripts', [$this->wordPressFrontendResources, 'registerJavaScriptModules']);
            ...
            if ($this->dialogSettingsConfig->get()->showDialogOnLoginPage === true) {
                ...
                $this->wpFunction->addAction('login_head', [$this->resourceEnqueuer, 'enableClassicScriptEnqueue']);
                $this->wpFunction->addAction('login_head', [$this->wordPressFrontendResources, 'registerJavaScriptModules']);
