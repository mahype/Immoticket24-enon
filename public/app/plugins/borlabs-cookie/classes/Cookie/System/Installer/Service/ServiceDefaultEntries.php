...
use Borlabs\Cookie\System\Installer\Service\Entry\BorlabsCookieEntry;

final class ServiceDefaultEntries extends DefaultEntriesManager
{
    public array $registry = [
        BorlabsCookieEntry::class,
    ];
}
