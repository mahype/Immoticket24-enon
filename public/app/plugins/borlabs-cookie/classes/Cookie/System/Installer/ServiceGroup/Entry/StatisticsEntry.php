...
final class StatisticsEntry implements DefaultEntryInterface
{
    ...
    public function getDefaultModel(): ServiceGroupModel
    {
        ...
        $model->description = $this->defaultLocalizationStrings->get()['serviceGroup']['statisticsDescription'];
        $model->key = 'statistics';
        $model->language = $this->language->getSelectedLanguageCode();
        $model->name = $this->defaultLocalizationStrings->get()['serviceGroup']['statisticsName'];
        $model->position = 2;
