...
final class ServiceComponent
{
    ...
    private function getServiceGroup(
        ...
        if ($serviceGroup === null && $serviceGroupKey !== null) {
            ...
            $serviceGroup->key = $serviceGroupKey;
            $serviceGroup->language = $languageCode;
            $serviceGroup->name = $serviceGroupKey;

            return $this->serviceGroupRepository->insert($serviceGroup);
        }
