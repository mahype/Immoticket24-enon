...
class PluginUpdateView {
	...
	<th colspan="%d" class="check-column" style="padding:0;">
    	<div class="plugin-update update-message notice inline notice-warning notice-alt" style="margin:10px 20px 10px 26px;border-top:1px solid #ffb900;box-shadow:4px 4px 4px #ffb9001a, 1px 1px 0px #ffb900;">
            ...
            \sprintf(
                ...
                $this->generateLicenseLink(__('Activate the license to receive automatic updates.', RPM_WP_CLIENT_TD))
            )
        );
    }
    /**
    ...
    protected function getAdminNoticeLicenseText($allowFirstDays = \false) {
        ...
        // translators:
        $text = __(
            'You have not yet activated a license for the %s plugin. Activate the licence to receive automatic updates.',
            RPM_WP_CLIENT_TD
        );
        ...
        switch ($days) {
            ...
            case 6:
                // translators:
                $text = __(
                    'You have not yet activated your %s license. Activate your license now in the settings!',
                    RPM_WP_CLIENT_TD
                );
                break;
            case 7:
                // translators:
                $text = __(
                    'You are not allowed to use %s according to our license terms unless you have purchased a license. Activate it in the settings or buy one now!',
                    RPM_WP_CLIENT_TD
                );
                break;
            case 8:
