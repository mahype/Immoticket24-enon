    ...
    class Puc_v4p11_Scheduler
    {
        ...
        public function __construct($updateChecker, $checkPeriod, $hourlyHooks = array('load-plugins.php'))
        {
            ...
            if ($this->checkPeriod > 0) {
                ...
                $defaultSchedules = array(1 => 'hourly', 12 => 'twicedaily', 24 => 'daily');
                ...
                if (!\wp_next_scheduled($this->cronHook) && !\defined('WP_INSTALLING')) {
                    ...
                    $firstCheckTime = \apply_filters($this->updateChecker->getUniqueName('first_check_time'), $firstCheckTime);
        ...
        )
        {
            ...
            if (!\is_array($upgradeInfo) || !isset($upgradeInfo['type'], $upgradeInfo['action']) || 'update' !== $upgradeInfo['action'] || !\in_array($upgradeInfo['type'], array('plugin', 'theme'))) {
                return;
            }
        ...
        public function maybeCheckForUpdates()
        {
            ...
            $shouldCheck = \apply_filters($this->updateChecker->getUniqueName('check_now'), $shouldCheck, $state->getLastCheck(), $this->checkPeriod);
            if ($shouldCheck) {
