...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Theme_Package', \false)) {
    class Puc_v4p11_Theme_Package extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_InstalledPackage
    {
        ...
        {
            return array('Name' => 'Theme Name', 'ThemeURI' => 'Theme URI', 'Description' => 'Description', 'Author' => 'Author', 'AuthorURI' => 'Author URI', 'Version' => 'Version', 'Template' => 'Template', 'Status' => 'Status', 'Tags' => 'Tags', 'TextDomain' => 'Text Domain', 'DomainPath' => 'Domain Path');
        }
    }
}
