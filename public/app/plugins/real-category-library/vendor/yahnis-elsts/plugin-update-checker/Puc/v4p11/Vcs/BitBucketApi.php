...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Vcs_BitBucketApi', \false)) {
    class Puc_v4p11_Vcs_BitBucketApi extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Vcs_Api
    {
        ...
        public function getBranch($branchName)
        {
            ...
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Vcs_Reference(array('name' => $branch->name, 'updated' => $branch->target->date, 'downloadUrl' => $this->getDownloadUrl($branch->name)));
        }
        /**
         * Get a specific tag.
         *
        ...
        public function getTag($tagName)
        {
            ...
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Vcs_Reference(array('name' => $tag->name, 'version' => \ltrim($tag->name, 'v'), 'updated' => $tag->target->date, 'downloadUrl' => $this->getDownloadUrl($tag->name)));
        }
        /**
        ...
        public function api($url, $version = '2.0')
        {
            ...
            $url = \implode('/', array('https://api.bitbucket.org', $version, 'repositories', $this->username, $this->repository, $url));
            $baseUrl = $url;
            if ($this->oauth) {
        ...
        public function setAuthentication($credentials)
        {
            ...
            if (!empty($credentials) && !empty($credentials['consumer_key'])) {
                $this->oauth = new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_OAuthSignature($credentials['consumer_key'], $credentials['consumer_secret']);
            } else {
                $this->oauth = null;
            }
        }
