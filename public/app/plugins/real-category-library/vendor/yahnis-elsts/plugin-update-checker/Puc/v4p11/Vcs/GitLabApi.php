...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Vcs_GitLabApi', \false)) {
    class Puc_v4p11_Vcs_GitLabApi extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Vcs_Api
    {
        ...
        public function getLatestTag()
        {
            ...
            $tag = $versionTags[0];
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Vcs_Reference(array('name' => $tag->name, 'version' => \ltrim($tag->name, 'v'), 'downloadUrl' => $this->buildArchiveDownloadUrl($tag->name), 'apiResponse' => $tag));
        }
        /**
