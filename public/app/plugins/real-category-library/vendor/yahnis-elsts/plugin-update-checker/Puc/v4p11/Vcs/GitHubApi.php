...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Vcs_GitHubApi', \false)) {
    class Puc_v4p11_Vcs_GitHubApi extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Vcs_Api
    {
        ...
        public function getLatestRelease()
        {
            ...
            $reference = new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Vcs_Reference(array(
        ...
        public function getLatestTag()
        {
            ...
            $tag = $versionTags[0];
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Vcs_Reference(array('name' => $tag->name, 'version' => \ltrim($tag->name, 'v'), 'downloadUrl' => $tag->zipball_url, 'apiResponse' => $tag));
        }
        /**
        ...
        public function getBranch($branchName)
        {
            ...
            $reference = new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Vcs_Reference(array('name' => $branch->name, 'downloadUrl' => $this->buildArchiveDownloadUrl($branch->name), 'apiResponse' => $branch));
        ...
        public function setAuthentication($credentials)
        {
            ...
            \add_filter('upgrader_pre_download', array($this, 'addHttpRequestFilter'), 10, 1);
            //WP 3.7+
        }
        /**
