...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Vcs_Api')) {
    abstract class Puc_v4p11_Vcs_Api
    {
         ...
         */
        public abstract function chooseReference($configBranch);
        /**
         ...
         */
        public abstract function getBranch($branchName);
        /**
         * Get a specific tag.
         *
         ...
         * @return Puc_v4p11_Vcs_Reference|null
         */
        public abstract function getTag($tagName);
        /**
         ...
         * @return Puc_v4p11_Vcs_Reference|null
         */
        public abstract function getLatestTag();
        /**
         ...
         */
        public abstract function getRemoteFile($path, $ref = 'master');
        /**
         ...
         * @return string|null
         */
        public abstract function getLatestCommitTime($ref);
        /**
