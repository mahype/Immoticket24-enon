...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_OAuthSignature', \false)) {
    ...
    class Puc_v4p11_OAuthSignature
    {
        ...
        public function sign($url, $method = 'GET')
        {
            ...
            $parameters = \array_merge($parameters, array('oauth_consumer_key' => $this->consumerKey, 'oauth_nonce' => $this->nonce(), 'oauth_signature_method' => 'HMAC-SHA1', 'oauth_timestamp' => \time(), 'oauth_version' => '1.0'));
