...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Vcs_PluginUpdateChecker')) {
    class Puc_v4p11_Vcs_PluginUpdateChecker extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Plugin_UpdateChecker implements \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Vcs_BaseChecker
    {
        /**
        ...
        {
            $headerToPropertyMap = array('Version' => 'version', 'Name' => 'name', 'PluginURI' => 'homepage', 'Author' => 'author', 'AuthorName' => 'author', 'AuthorURI' => 'author_homepage', 'Requires WP' => 'requires', 'Tested WP' => 'tested', 'Requires at least' => 'requires', 'Tested up to' => 'tested', 'Requires PHP' => 'requires_php');
