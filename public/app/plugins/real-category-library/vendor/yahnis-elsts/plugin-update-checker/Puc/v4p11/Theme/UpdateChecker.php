...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Theme_UpdateChecker', \false)) {
    class Puc_v4p11_Theme_UpdateChecker extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_UpdateChecker
    {
        ...
        {
            return \array_merge(parent::getNoUpdateItemFields(), array('theme' => $this->directoryName, 'requires' => ''));
        }
        ...
        {
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Scheduler($this, $checkPeriod, array('load-themes.php'));
        }
        /**
        ...
        {
            return new \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_DebugBar_Extension($this, 'Puc_v4p11_DebugBar_ThemePanel');
        }
        /**
