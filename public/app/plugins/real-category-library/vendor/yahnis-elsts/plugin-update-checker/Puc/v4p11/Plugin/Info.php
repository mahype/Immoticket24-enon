...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Plugin_Info', \false)) {
    ...
    class Puc_v4p11_Plugin_Info extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Metadata
    {
        ...
        public function toWpFormat()
        {
            ...
            $sameFormat = array('name', 'slug', 'version', 'requires', 'tested', 'rating', 'upgrade_notice', 'num_ratings', 'downloaded', 'active_installs', 'homepage', 'last_updated', 'requires_php');
            ...
            if (!empty($this->banners)) {
                ...
                $info->banners = \array_intersect_key($info->banners, array('high' => \true, 'low' => \true));
            }
            return $info;
        }
