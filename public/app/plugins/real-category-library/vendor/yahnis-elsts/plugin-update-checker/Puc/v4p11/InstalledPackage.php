...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_InstalledPackage', \false)) {
    ...
    abstract class Puc_v4p11_InstalledPackage
    {
         ...
         */
        public abstract function getInstalledVersion();
        /**
         * Get the full path of the plugin or theme directory (without a trailing slash).
         *
         * @return string
         */
        public abstract function getAbsoluteDirectoryPath();
        /**
         ...
         */
        protected abstract function getHeaderNames();
        /**
         ...
         */
        public abstract function getHeaderValue($headerName);
    }
}
