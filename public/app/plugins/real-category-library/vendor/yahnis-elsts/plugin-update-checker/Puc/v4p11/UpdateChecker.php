...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_UpdateChecker', \false)) {
    abstract class Puc_v4p11_UpdateChecker
    {
        ...
        public function removeHooks()
        {
            ...
            \remove_action('delete_site_transient_' . $this->updateTransient, array($this, 'clearCachedTranslationUpdates'));
         ...
         * @return bool
         */
        public abstract function userCanInstallUpdates();
        /**
         ...
         */
        protected abstract function createInstalledPackage();
        /**
         * @return Puc_v4p11_InstalledPackage
         */
         ...
         */
        protected abstract function createScheduler($checkPeriod);
        /**
        ...
        public function checkForUpdates()
        {
            ...
            $state->setLastCheckToNow()->setCheckedVersion($installedVersion)->save();
         ...
         */
        public abstract function requestUpdate();
        /**
         ...
         */
        protected function fixSupportedWordpressVersion(\DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Metadata $update = null)
        {
        ...
        {
            return array('new_version' => $this->getInstalledVersion(), 'url' => '', 'package' => '', 'requires_php' => '');
        }
        /**
         ...
         * @return string
         */
        protected abstract function getUpdateListKey();
        /**
        ...
        protected function requestMetadata($metaClass, $filterRoot, $queryArgs = array())
        {
            ...
            $queryArgs = \array_merge(array('installed_version' => \strval($this->getInstalledVersion()), 'php' => \phpversion(), 'locale' => \get_locale()), $queryArgs);
        ...
        public function injectTranslationUpdates($updates)
        {
            ...
            $updates->translations = \array_values(\array_filter($updates->translations, array($this, 'isNotMyTranslation')));
         ...
         * @return bool
         */
        public abstract function isBeingUpgraded($upgrader = null);
        /**
        ...
        {
            if (\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Debug_Bar', \false) && \file_exists(\dirname(__FILE__) . '/DebugBar')) {
