...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Vcs_ThemeUpdateChecker', \false)) {
    class Puc_v4p11_Vcs_ThemeUpdateChecker extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Theme_UpdateChecker implements \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Vcs_BaseChecker
    {
        /**
        ...
        public function requestUpdate()
        {
            ...
            $update->version = \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Utils::findNotEmpty(array($remoteHeader['Version'], \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Utils::get($updateSource, 'version')));
            //The details URL defaults to the Theme URI header or the repository URL.
            $update->details_url = \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Utils::findNotEmpty(array($remoteHeader['ThemeURI'], $this->package->getHeaderValue('ThemeURI'), $this->metadataUrl));
