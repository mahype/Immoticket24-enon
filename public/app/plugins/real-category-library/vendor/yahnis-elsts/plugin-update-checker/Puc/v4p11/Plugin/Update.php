...
if (!\class_exists('DevOwl\\RealCategoryLibrary\\Vendor\\Puc_v4p11_Plugin_Update', \false)) {
    ...
    class Puc_v4p11_Plugin_Update extends \DevOwl\RealCategoryLibrary\Vendor\Puc_v4p11_Update
    {
        ...
        protected static $extraFields = array('id', 'homepage', 'tested', 'requires_php', 'upgrade_notice', 'icons', 'filename');
        /**
        ...
        public function toWpFormat()
        {
            ...
            if (!empty($this->icons) && \is_array($this->icons)) {
                ...
                $icons = \array_intersect_key($this->icons, array('svg' => \true, '1x' => \true, '2x' => \true, 'default' => \true));
                if (!empty($icons)) {
                    $update->icons = $icons;
