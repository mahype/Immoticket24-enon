...
return array(
	'title' => __( 'Gesamtluftwechsel Korrekturfaktor Wohngebäude (über 1500m3)', 'wpenon' ),
	'description' => __( 'Diese Tabelle enthält Korrekturfaktor für die Gesamtluftwechwselraten für Wohngebäude über 1500m3.', 'wpenon' ) . ' ' . __( 'Diese Daten werden für den Bedarfsausweis benötigt.', 'wpenon' ),
	...
	'fields' => array(
		...
		'av_verhaeltnis' => array(
			'title' => __( 'Hüllfläche / Nettoraumvolumen', 'wpenon' ),
			'type' => 'FLOAT',
		),
		'ohne' => array(
