...
/**
 *  Pelletkessel (Baujahr nach 1994) — Hilfsenergieaufwand - Tabelle 85.
 */
return array(
	'title'         => __( 'Pelletkessel Hilfsenergieaufwand', 'wpenon' ),
	'description'   => __( 'Pelletkessel (Baujahr nach 1994) — Hilfsenergieaufwand', 'wpenon' ),
	'asterisks'     => array(),
	'primary_field' => 'id',
	'search_field'  => 'id',
	'search_before' => true,
