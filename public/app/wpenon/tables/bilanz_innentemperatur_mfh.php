...
return array(
  'title'         => __( 'Bilanz-Innentemperatur Mehrfamilienhaus', 'wpenon' ),
  'description'   => __( 'Diese Tabelle enthält Bilanz-Innentemperatur für Wohngebäude – Mehrfamilienhaus', 'wpenon' ) . ' ' . __( 'Diese Daten werden für den Bedarfsausweis benötigt.', 'wpenon' ),
