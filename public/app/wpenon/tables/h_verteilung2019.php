...
return array(
	'title' => __( 'Heizenergie-Verteilung 2019', 'wpenon' ),
	'description' => __( 'Diese Tabelle enthält die standardisierten Wärmeverluste und Hilfsenergiewerte für die Heizenergie-Verteilung.', 'wpenon' ) . ' ' . __( 'Diese Daten werden für den Bedarfsausweis benötigt.', 'wpenon' ),
	'asterisks' => array(
	...
	'fields' => array(
		...
		'he150_1978' => array(
			'title' => __( 'HE<sup>2</sup> 150m&sup2; (bis 1978)', 'wpenon' ),
			'type' => 'FLOAT',
		),
		'he500_1978' => array(
			'title' => __( 'HE<sup>2</sup> 500m&sup2; (bis 1978)', 'wpenon' ),
			'type' => 'FLOAT',
		),
		'he2500_1978' => array(
			'title' => __( 'HE<sup>2</sup> 2500m&sup2; (bis 1978)', 'wpenon' ),
			'type' => 'FLOAT',
		),
		'wv150_1978d' => array(
		...
		'he150_1978d' => array(
			'title' => __( 'HE<sup>2</sup> 150m&sup2; (bis 1978, nachtr. gedämmt)', 'wpenon' ),
			'type' => 'FLOAT',
		),
		'he500_1978d' => array(
			'title' => __( 'HE<sup>2</sup> 500m&sup2; (bis 1978, nachtr. gedämmt)', 'wpenon' ),
			'type' => 'FLOAT',
		),
		'he2500_1978d' => array(
			'title' => __( 'HE<sup>2</sup> 2500m&sup2; (bis 1978, nachtr. gedämmt)', 'wpenon' ),
			'type' => 'FLOAT',
		),
		'wv150_1994' => array(
