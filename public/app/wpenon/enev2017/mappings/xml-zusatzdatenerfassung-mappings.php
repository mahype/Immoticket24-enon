    ...
    switch ( $data['mode'] ) {
      ...
      case 'attribute':
        ...
        switch ( $attribute['name'] ) {
          case 'EnEV-Version':
            return (new \Enon\Enon\Standard( $energieausweis->wpenon_standard, (new \Enon\Enon\Standards() )))->getDate('Y');
          case 'Rechtsstand':
      ...
      case 'value':
        ...
        switch ( $context ) {
          ...
          case 'Modernisierungsempfehlungen::9_Nummer':
            $parent_index = absint( str_replace( array( 'Modernisierungsempfehlungen::', '_Nummer' ), '', $context ) );
          ...
          case 'Modernisierungsempfehlungen::9_Massnahmenbeschreibung':
            $parent_index = absint( str_replace( array( 'Modernisierungsempfehlungen::', '_Massnahmenbeschreibung' ), '', $context ) );
            $modernisierungsempfehlungen = wpenon_immoticket24_get_modernisierungsempfehlungen( $energieausweis );
            if ( isset( $modernisierungsempfehlungen[ $parent_index ] ) ) {
          ...
          case 'Modernisierungsempfehlungen::9_Modernisierungskombination':
            $parent_index = absint( str_replace( array( 'Modernisierungsempfehlungen::', '_Modernisierungskombination' ), '', $context ) );
            $modernisierungsempfehlungen = wpenon_immoticket24_get_modernisierungsempfehlungen( $energieausweis );
            if ( isset( $modernisierungsempfehlungen[ $parent_index ] ) ) {
          ...
          case 'Bauteil-Opak::24_Flaechenbezeichnung':
            $calculations = $energieausweis->calculate();
            $bauteile_opak = wp_list_filter( $calculations['bauteile'], array( 'modus' => 'opak' ) );
            $index = absint( str_replace( array( 'Bauteil-Opak::', '_Flaechenbezeichnung' ), '', $context ) );
          ...
          case 'Bauteil-Opak::24_Flaeche':
            $calculations = $energieausweis->calculate();
            $bauteile_opak = wp_list_filter( $calculations['bauteile'], array( 'modus' => 'opak' ) );
            $index = absint( str_replace( array( 'Bauteil-Opak::', '_Flaeche' ), '', $context ) );
            $key = array_keys( $bauteile_opak )[ $index ];
          ...
          case 'Bauteil-Opak::24_U-Wert':
            $calculations = $energieausweis->calculate();
            $bauteile_opak = wp_list_filter( $calculations['bauteile'], array( 'modus' => 'opak' ) );
            $index = absint( str_replace( array( 'Bauteil-Opak::', '_U-Wert' ), '', $context ) );
            $key = array_keys( $bauteile_opak )[ $index ];
          ...
          case 'Bauteil-Opak::24_Ausrichtung':
            $calculations = $energieausweis->calculate();
            $bauteile_opak = wp_list_filter( $calculations['bauteile'], array( 'modus' => 'opak' ) );
            $index = absint( str_replace( array( 'Bauteil-Opak::', '_Ausrichtung' ), '', $context ) );
            $key = array_keys( $bauteile_opak )[ $index ];
          ...
          case 'Bauteil-Opak::24_grenztAn':
            $calculations = $energieausweis->calculate();
            $bauteile_opak = wp_list_filter( $calculations['bauteile'], array( 'modus' => 'opak' ) );
            $index = absint( str_replace( array( 'Bauteil-Opak::', '_grenztAn' ), '', $context ) );
            $key = array_keys( $bauteile_opak )[ $index ];
          ...
          case 'Bauteil-Transparent::15_Flaechenbezeichnung':
            $calculations = $energieausweis->calculate();
            $bauteile_transparent = wp_list_filter( $calculations['bauteile'], array( 'modus' => 'transparent' ) );
            $index = absint( str_replace( array( 'Bauteil-Transparent::', '_Flaechenbezeichnung' ), '', $context ) );
          ...
          case 'Bauteil-Transparent::15_Flaeche':
            $calculations = $energieausweis->calculate();
            $bauteile_transparent = wp_list_filter( $calculations['bauteile'], array( 'modus' => 'transparent' ) );
            $index = absint( str_replace( array( 'Bauteil-Transparent::', '_Flaeche' ), '', $context ) );
            $key = array_keys( $bauteile_transparent )[ $index ];
            return (int) $calculations['bauteile'][ $key ]['a'];
          ...
          case 'Bauteil-Transparent::15_U-Wert':
            $calculations = $energieausweis->calculate();
            $bauteile_transparent = wp_list_filter( $calculations['bauteile'], array( 'modus' => 'transparent' ) );
            $index = absint( str_replace( array( 'Bauteil-Transparent::', '_U-Wert' ), '', $context ) );
            $key = array_keys( $bauteile_transparent )[ $index ];
            return round( (float) $calculations['bauteile'][ $key ]['u'], 3 );
          ...
          case 'Bauteil-Transparent::15_g-Wert':
            $calculations = $energieausweis->calculate();
            $bauteile_transparent = wp_list_filter( $calculations['bauteile'], array( 'modus' => 'transparent' ) );
            $index = absint( str_replace( array( 'Bauteil-Transparent::', '_g-Wert' ), '', $context ) );
            $key = array_keys( $bauteile_transparent )[ $index ];
          ...
          case 'Bauteil-Transparent::15_Ausrichtung':
            $calculations = $energieausweis->calculate();
            $bauteile_transparent = wp_list_filter( $calculations['bauteile'], array( 'modus' => 'transparent' ) );
            $index = absint( str_replace( array( 'Bauteil-Transparent::', '_Ausrichtung' ), '', $context ) );
            $key = array_keys( $bauteile_transparent )[ $index ];
            if ( ! empty( $calculations['bauteile'][ $key ]['richtung'] ) ) {
              return strtoupper( $calculations['bauteile'][ $key ]['richtung'] );
            }
          ...
          case 'Bauteil-Dach::15_Flaechenbezeichnung':
            $calculations = $energieausweis->calculate();
            $bauteile_dach = wp_list_filter( $calculations['bauteile'], array( 'modus' => 'dach' ) );
            $index = absint( str_replace( array( 'Bauteil-Dach::', '_Flaechenbezeichnung' ), '', $context ) );
          ...
          case 'Bauteil-Dach::15_Flaeche':
            $calculations = $energieausweis->calculate();
            $bauteile_dach = wp_list_filter( $calculations['bauteile'], array( 'modus' => 'dach' ) );
            $index = absint( str_replace( array( 'Bauteil-Dach::', '_Flaeche' ), '', $context ) );
            $key = array_keys( $bauteile_dach )[ $index ];
            return (int) $calculations['bauteile'][ $key ]['a'];
          ...
          case 'Bauteil-Dach::15_U-Wert':
            $calculations = $energieausweis->calculate();
            $bauteile_dach = wp_list_filter( $calculations['bauteile'], array( 'modus' => 'dach' ) );
            $index = absint( str_replace( array( 'Bauteil-Dach::', '_U-Wert' ), '', $context ) );
            $key = array_keys( $bauteile_dach )[ $index ];
            return round( (float) $calculations['bauteile'][ $key ]['u'], 3 );
          // Heizungsanlage
          ...
          case 'Heizungsanlage::2_Waermeerzeuger-Bauweise-4701':
            $calculations = $energieausweis->calculate();
            $key = absint( str_replace( array( 'Heizungsanlage::', '_Waermeerzeuger-Bauweise-4701' ), '', $context ) );
            $count = 0;
            foreach ( $calculations['anlagendaten'] as $anlage ) {
              if ( $anlage['art'] == 'heizung' ) {
                if ( $key == $count ) {
          ...
          case 'Heizungsanlage::2_Nennleistung':
            $calculations = $energieausweis->calculate();
            $key = absint( str_replace( array( 'Heizungsanlage::', '_Nennleistung' ), '', $context ) );
            $count = 0;
            foreach ( $calculations['anlagendaten'] as $anlage ) {
              if ( $anlage['art'] == 'heizung' ) {
                if ( $key == $count ) {
          ...
          case 'Heizungsanlage::2_Waermeerzeuger-Baujahr':
            $calculations = $energieausweis->calculate();
            $key = absint( str_replace( array( 'Heizungsanlage::', '_Waermeerzeuger-Baujahr' ), '', $context ) );
            $count = 0;
            foreach ( $calculations['anlagendaten'] as $anlage ) {
              if ( $anlage['art'] == 'heizung' ) {
                if ( $key == $count ) {
          ...
          case 'Heizungsanlage::2_Anzahl-baugleiche':
            $calculations = $energieausweis->calculate();
            $key = absint( str_replace( array( 'Heizungsanlage::', '_Anzahl-baugleiche' ), '', $context ) );
            $count = 0;
            foreach ( $calculations['anlagendaten'] as $anlage ) {
              if ( $anlage['art'] == 'heizung' ) {
                if ( $key == $count ) {
          ...
          case 'Heizungsanlage::2_Energietraeger':
            $calculations = $energieausweis->calculate();
            $key = absint( str_replace( array( 'Heizungsanlage::', '_Energietraeger' ), '', $context ) );
            $count = 0;
            foreach ( $calculations['anlagendaten'] as $anlage ) {
              if ( $anlage['art'] == 'heizung' ) {
                if ( $key == $count ) {
          ...
          case 'Heizungsanlage::2_Primaerenergiefaktor':
            $calculations = $energieausweis->calculate();
            $key = absint( str_replace( array( 'Heizungsanlage::', '_Primaerenergiefaktor' ), '', $context ) );
            $count = 0;
            foreach ( $calculations['anlagendaten'] as $anlage ) {
              if ( $anlage['art'] == 'heizung' ) {
                if ( $key == $count ) {
          ...
          case 'Trinkwarmwasseranlage::2_Trinkwarmwassererzeuger-Bauweise-4701':
            $calculations = $energieausweis->calculate();
            $key = absint( str_replace( array( 'Trinkwarmwasseranlage::', '_Trinkwarmwassererzeuger-Bauweise-4701' ), '', $context ) );
            $count = 0;
            foreach ( $calculations['anlagendaten'] as $anlage ) {
              if ( $anlage['art'] == 'warmwasser' ) {
                if ( $key == $count ) {
          ...
          case 'Trinkwarmwasseranlage::2_Trinkwarmwassererzeuger-Baujahr':
            $calculations = $energieausweis->calculate();
            $key = absint( str_replace( array( 'Trinkwarmwasseranlage::', '_Trinkwarmwassererzeuger-Baujahr' ), '', $context ) );
            $count = 0;
            foreach ( $calculations['anlagendaten'] as $anlage ) {
              if ( $anlage['art'] == 'warmwasser' ) {
                if ( $key == $count ) {
          ...
          case 'Trinkwarmwasseranlage::2_Anzahl-baugleiche':
            $calculations = $energieausweis->calculate();
            $key = absint( str_replace( array( 'Trinkwarmwasseranlage::', '_Anzahl-baugleiche' ), '', $context ) );
            $count = 0;
            foreach ( $calculations['anlagendaten'] as $anlage ) {
              if ( $anlage['art'] == 'warmwasser' ) {
                if ( $key == $count ) {
