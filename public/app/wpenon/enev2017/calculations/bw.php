...
$calculations['anlagendaten']['h'] = array(
  ...
  'energietraeger_co2'      => $energieausweis->h_custom ? floatval( $energieausweis->h_custom_co2 ) : floatval( $h_energietraeger->co2 ),
...
if ( $energieausweis->h2_info ) {
  ...
  if ( $energieausweis->h2_deckungsanteil > 0 ) {
    ...
    $calculations['anlagendaten']['h2'] = array(
      ...
      'energietraeger_co2'      => $energieausweis->h2_custom ? floatval( $energieausweis->h2_custom_co2 ) : floatval( $h2_energietraeger->co2 ),
  ...
  if ( $energieausweis->h3_info && $energieausweis->h3_deckungsanteil > 0 ) {
    ...
    $calculations['anlagendaten']['h3'] = array(
      ...
      'energietraeger_co2'      => $energieausweis->h3_custom ? floatval( $energieausweis->h3_custom_co2 ) : floatval( $h3_energietraeger->co2 ),
