...
namespace Enev\Schema202402\Calculations\Anlagentechnik\Heizungsanlagen;

use Enev\Schema202402\Calculations\Anlagentechnik\Heizungsanlage;
use Enev\Schema202402\Calculations\Calculation_Exception;
use Enev\Schema202402\Calculations\Gebaeude\Gebaeude;
use Enev\Schema202402\Calculations\Tabellen\Aufwandszahlen_Brennwertkessel;
use Enev\Schema202402\Calculations\Tabellen\Aufwandszahlen_Heizwaermeerzeugung;
use Enev\Schema202402\Calculations\Tabellen\Aufwandszahlen_Heizwaermeerzeugung_Korrekturfaktor;
use Enev\Schema202402\Calculations\Tabellen\Aufwandszahlen_Umlaufwasserheizer;
use Enev\Schema202402\Calculations\Tabellen\Betriebsbereitschaftsleistung_Pellet_Holzhackschnitzelkessel;
use Enev\Schema202402\Calculations\Tabellen\Brennwertkessel_Hilfsenergieaufwand;
use Enev\Schema202402\Calculations\Tabellen\Laufzeit_Waermeerzeuger_Trinkwassererwaermung;
use Enev\Schema202402\Calculations\Tabellen\Umlaufwasserheizer_Hilfsenergieaufwand;
use Enev\Schema202402\Calculations\Tabellen\Pelletkessel_Hilfsenergieaufwand;
