		...
		'bauteile_basis'   => array(
			...
			'fields'      => array(
				'wand_staerke'    => array(
					...
					'options'     => \Enev\Schema202301\Schema\Standard_Options::get_wandstaerken(),
					'required'    => true,
					'unit'     => 'cm',
				),
				'wand_bauart_holz'          => array(
					...
					'options'     => \Enev\Schema202301\Schema\Standard_Options::get_bauarten_holzhaus(),
					'required'    => true,
					'display'     => array(
				...
				'wand_bauart_fachwerk'      => array(
					...
					'label'       => __( 'Wandbauart', 'wpenon' ),
					'description' => __( 'Wählen Sie die Bauart der Außenwand aus.', 'wpenon' ),
					'options'     => \Enev\Schema202301\Schema\Standard_Options::get_bauarten_fachwerkaus(),
					'required'    => true,
					'display'     => array(
						'callback'      => 'wpenon_immoticket24_show_wand_bauart',
		...
		'bauteile_dach'    => array(
			...
			'fields'      => array(
				...
				'dach_form'          => array(
					...
					'options'     => \Enev\Schema202301\Schema\Standard_Options::get_dach_formen(),
					'required'    => true,
					'display'     => array(
				...
				'dach_bauart'        => array(
					...
					'options'     => \Enev\Schema202301\Schema\Standard_Options::get_bauarten(),
					'required'    => true,
					'display'     => array(
						'callback'      => 'wpenon_show_on_array_whitelist',
		...
		'bauteile_keller'  => array(
			...
			'fields'      => array(
				...
				'keller_bauart'       => array(
					...
					'options'     => \Enev\Schema202301\Schema\Standard_Options::get_bauarten_keller(),
					'required'    => true,
					'display'     => array(
						'callback'      => 'wpenon_show_on_array_whitelist',
						'callback_args' => array( 'field::keller', 'beheizt' ),
				...
				'boden_bauart'        => array(
					...
					'options'     => \Enev\Schema202301\Schema\Standard_Options::get_bauarten_boden(),
					'required'    => true,
				),
