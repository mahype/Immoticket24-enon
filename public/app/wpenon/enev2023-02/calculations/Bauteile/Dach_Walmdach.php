    ...
    public function berechnen() {
        switch ( $this->grundriss->form() ) {
            case 'a':
                ...
                $this->flaeche += 2 * ( 0.5 * $dach_b * $dach_sw + 0.5 * ( $dach_th + $dach_f ) * $dach_sh );
                $this->volumen += ( 1.0 / 3.0 ) * ( 2 * $dach_b ) * ( 2 * $dach_x ) * $this->hoehe + 0.5 * ( 2 * $dach_b ) * $dach_f * $this->hoehe;
            case 'b':
                ...
                $this->flaeche += 0.5 * $dach_b1_gross * $dach_s1 + 0.5 * $dach_b2_gross * $dach_s2 + 0.5 * ( $dach_t1 + $dach_f1 ) * $dach_s2 + 0.5 * ( $dach_t2 + $dach_f2 ) * $dach_s1 + ( 0.5 * ( $dach_t2 + $dach_f2 ) * $dach_s1 - 0.5 * $dach_b2_gross * $dach_s2 ) + $dach_t3 * $dach_s2;
                $this->volumen += ( 1.0 / 3.0 ) * $dach_b1_gross * $dach_b1_gross * $this->hoehe + 0.5 * $dach_b1_gross * $dach_f2 * $this->hoehe + 0.5 * $dach_b2_gross * $dach_t3 * $this->hoehe;
                break;
            case 'c':
                ...
                $dach_s2 = sqrt(pow($this->hoehe, 2) + pow($dach_b2, 2));
                array_push($dachwinkel, atan($this->hoehe / $dach_b1), atan($this->hoehe / $dach_b2));
                $this->flaeche += 2 * ( 0.5 * $dach_b1_gross * $dach_s1 ) + 0.5 * $dach_b2_gross * $dach_s2 + 0.5 * ( $dach_t2 + $dach_f2 ) * $dach_s1 + ( 0.5 * ( $dach_t2 + $dach_f2 ) * $dach_s1 - 0.5 * $dach_b2_gross * $dach_s2 ) + 2 * ( $dach_t3 * $dach_s2 );
                $this->volumen += ( 1.0 / 3.0 ) * $dach_b1_gross * $dach_b1_gross * $this->hoehe + 0.5 * $dach_b1_gross * $dach_f2 * $this->hoehe + 0.5 * $dach_b2_gross * $dach_t3 * $this->hoehe;
                break;
            case 'd':
                ...
                $this->flaeche += 0.5 * $dach_b2_gross * $dach_s2 + 0.5 * $dach_b3_gross * $dach_s3 + 0.5 * ( $dach_t1 + $dach_f1 ) * $dach_s2 + 0.5 * ( $dach_t2 + $dach_f2 ) * $dach_s1 + 0.5 * ( $dach_t3 + $dach_f3 ) * $dach_s3 + $dach_t4 * $dach_s2 + 0.5 * ( $dach_t5 + $dach_f2 ) * $dach_s1 + $dach_t6 * $dach_s3;
                $this->volumen += ( 1.0 / 3.0 ) * $dach_b1_gross * $dach_b1_gross * $this->hoehe + 0.5 * $dach_b1_gross * $dach_f2 * $this->hoehe + 0.5 * $dach_b2_gross * $dach_t4 * $this->hoehe + 0.5 * $dach_b3_gross * $dach_t6 * $this->hoehe;
                break;
            default:
            }
    }
