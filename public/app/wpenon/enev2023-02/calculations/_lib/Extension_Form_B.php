 ...
 * @since 1.0.0
 */
class Extension_Form_B extends Extension {
	/**
	 * Length of s1
	 *
	 * @var float
	...
	protected function validate_data() {
		if ( empty( $this->height ) || empty( $this->s1 ) || empty( $this->s2 ) || empty( $this->t )) {
			return false;
		}
	 ...
	 * @since 1.0.0
	 */
	public function set_walls( float $length_s1, float $length_s2, float $length_t, float $length_b ) {
		$this->length_s1 = $length_s1;
		$this->length_s2 = $length_s2;
	 ...
	 *
	 * @return bool|float Surface area value, false if data could not be validated.
	 *
	 * @since 1.0.0
	 */
	...
	public function get_surface_area_s2() {
		return ( $this->get_length_b() - $this->get_length_s2() ) * ( $this->height + 0.5 );
	}
	...
	public function get_floor_space() {
		$rectangle_1 = $this->get_length_s3() * $this->get_length_b();
		$rectangle_2 = $this->get_length_s1() * $this->get_length_s4();
	...
	public function get_surface_area() {
		return $this->get_surface_area_s3() + $this->get_surface_area_s4() + $this->get_surface_area_t() + $this->get_surface_area_b();
	}
	 ...
	 * @since 1.0.0
	 */
	public function get_length_s3() {
		return $this->length_t - $this->length_s1;
	}
	 ...
	 * @since 1.0.0
	 */
	public function get_length_s4() {
		return $this->length_b - $this->length_s2;
	}
}
