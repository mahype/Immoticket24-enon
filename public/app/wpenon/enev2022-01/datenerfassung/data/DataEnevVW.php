...
use Enev\Schema202201\Modernizations\VW_Modernizations;
...
class DataEnevVW extends DataEnev {
     ...
     * @since 1.0.0
     */
    private Enev\Schema202201\Calculations\CalculationsCC $calculations;
     ...
     * @since 1.0.0
     */
    public function calculations() : Enev\Schema202201\Calculations\CalculationsCC
    {
        if ( empty( $this->calculations ) )
        {
            $this->calculations = new Enev\Schema202201\Calculations\CalculationsCC( $this->energieausweis );
        }
