 ...
 * @package
 */
class Aufwandszahlen_Heizwaermeerzeugung_Fernwaerme {
	/**
	...
	public function __construct( float $pn, float $ßhg ) {
		...
		$this->ßhg            = $ßhg;
		$this->table_data     = wpenon_get_table_results( 'heizwaermeerzeugung_fernwaerme' );
	}
