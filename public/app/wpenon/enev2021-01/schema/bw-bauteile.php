		...
		'bauteile_basis'   => array(
			...
			'fields'      => array(
				...
				'wand_a_daemmung_baujahr'        => array(
					'type'                  => 'int',
					'label'                 => __( 'Baujahr der nachträglichen Dämmung', 'wpenon' ),
					'description'           => sprintf( __( 'Geben Sie das Baujahr der nachträglichen Dämmung an Wand %s an..', 'wpenon' ), 'a' ),
					'min'                   => 1800,					
					...
					'value'                 => array(
						...
						'callback_args' => array( 'field::baujahr', 'field::wand_a_daemmung_baujahr' ),
					),	
				),
				...
				'wand_b_daemmung_baujahr'        => array(
					'type'                  => 'int',
					'label'                 => __( 'Baujahr der nachträglichen Dämmung', 'wpenon' ),
					'description'           => sprintf( __( 'Geben Sie das Baujahr der nachträglichen Dämmung an Wand %s an..', 'wpenon' ), 'b' ),
					'min'                   => 1800,					
					'max'                   => wpenon_get_reference_date( 'Y' ),
					'required'              => true,
					'display'               => array(
					...
					'value'                 => array(
						'callback'      => 'wpenon_get_construction_year',
						'callback_args' => array( 'field::baujahr', 'field::wand_b_daemmung_baujahr' ),
					),	
				),
				...
				'wand_c_daemmung_baujahr'        => array(
					'type'                  => 'int',
					'label'                 => __( 'Baujahr der nachträglichen Dämmung', 'wpenon' ),
					'description'           => sprintf( __( 'Geben Sie das Baujahr der nachträglichen Dämmung an Wand %s an..', 'wpenon' ), 'c' ),
					'min'                   => 1800,					
					'max'                   => wpenon_get_reference_date( 'Y' ),
					'required'              => true,
					'display'               => array(
					...
					'value'                 => array(
						'callback'      => 'wpenon_get_construction_year',
						'callback_args' => array( 'field::baujahr', 'field::wand_c_daemmung_baujahr' ),
					),	
				),
				...
				'wand_d_daemmung_baujahr'        => array(
					...
					'value'                 => array(
						'callback'      => 'wpenon_get_construction_year',
						'callback_args' => array( 'field::baujahr', 'field::wand_d_daemmung_baujahr' ),
					),	
				),
				...
				'wand_e_daemmung_baujahr'        => array(
					...
					'value'                 => array(
						'callback'      => 'wpenon_get_construction_year',
						'callback_args' => array( 'field::baujahr', 'field::wand_e_daemmung_baujahr' ),
					),	
				),
				...
				'wand_f_daemmung_baujahr'        => array(
					...
					'value'                 => array(
						'callback'      => 'wpenon_get_construction_year',
						'callback_args' => array( 'field::baujahr', 'field::wand_f_daemmung_baujahr' ),
					),	
				),
				...
				'wand_g_daemmung_baujahr'        => array(
					...
					'value'                 => array(
						'callback'      => 'wpenon_get_construction_year',
						'callback_args' => array( 'field::baujahr', 'field::wand_g_daemmung_baujahr' ),
					),	
				),
				...
				'wand_h_daemmung_baujahr'        => array(
					...
					'value'                 => array(
						'callback'      => 'wpenon_get_construction_year',
						'callback_args' => array( 'field::baujahr', 'field::wand_h_daemmung_baujahr' ),
					),	
				),
				...
				'anbauwand_daemmung_baujahr'        => array(
					...
					'value'                 => array(
						'callback'      => 'wpenon_get_construction_year',
						'callback_args' => array( 'field::baujahr', 'field::anbauwand_daemmung_baujahr' ),
					),	
				),
		...
		'bauteile_dach'    => array(
			...
			'fields'      => array(
				...
				'dach_daemmung_baujahr'        => array(
					...
					'value'                 => array(
						'callback'      => 'wpenon_get_construction_year',
						'callback_args' => array( 'field::baujahr', 'field::dach_daemmung_baujahr' ),
					),	
				),
				'decke_bauart'       => array(
					'type'        => 'select',
				...
				'decke_daemmung_baujahr'        => array(
					...
					'value'                 => array(
						'callback'      => 'wpenon_get_construction_year',
						'callback_args' => array( 'field::baujahr', 'field::decke_daemmung_baujahr' ),
					),	
				),
				...
				'anbaudach_daemmung_baujahr'        => array(
					...
					'value'                 => array(
						'callback'      => 'wpenon_get_construction_year',
						'callback_args' => array( 'field::baujahr', 'field::anbaudach_daemmung_baujahr' ),
					),	
				),
			),
		),
		'bauteile_keller'  => array(
			...
			'fields'      => array(
				...
				'keller_daemmung_baujahr'        => array(
					...
					'value'                 => array(
						'callback'      => 'wpenon_get_construction_year',
						'callback_args' => array( 'field::baujahr', 'field::keller_daemmung_baujahr' ),
					),	
				),
				'boden_bauart'        => array(
					'type'        => 'select',
				...
				'boden_daemmung_baujahr'        => array(
					...
					'value'                 => array(
						'callback'      => 'wpenon_get_construction_year',
						'callback_args' => array( 'field::baujahr', 'field::boden_daemmung_baujahr' ),
					),	
				),		
				...
				'anbauboden_daemmung_baujahr'        => array(
					...
					'value'                 => array(
						'callback'      => 'wpenon_get_construction_year',
						'callback_args' => array( 'field::baujahr', 'field::anbauboden_daemmung_baujahr' ),
					),	
				),					
			),
		),
