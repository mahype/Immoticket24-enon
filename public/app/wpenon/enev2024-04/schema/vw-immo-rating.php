...
namespace Enev\Schema202404\Schema;

require_once(dirname(__FILE__) . '/vw.php');

if (!class_exists('\Enev\Schema202404\Schema\Verbrauchsausweis_Schema_Immo_Rating')) :
	 ...
	 * @since 1.0.0
	 */
	class Verbrauchsausweis_Schema_Immo_Rating extends Verbrauchsausweis_Schema
	{
		/**
...
$verbrauchsausweis_schema = new Verbrauchsausweis_Schema_Immo_Rating();
