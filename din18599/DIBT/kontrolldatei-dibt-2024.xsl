...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:n1="https://energieausweis.dibt.de/schema/Kontrollsystem-GEG-2024_V1_0.xsd" targetNamespace="https://energieausweis.dibt.de/schema/Kontrollsystem-GEG-2024_V1_0.xsd" elementFormDefault="qualified" attributeFormDefault="unqualified">
	<xs:annotation>
		<xs:documentation xml:lang="DE">
			Ausgabestand: 01.12.2023
		</xs:documentation>
	</xs:annotation>
	...
	<xs:complexType name="GEG-Daten">
		<xs:annotation>
			<xs:documentation xml:lang="DE">
				Dieser Block besteht aus drei Komponenten:
				Dem Block mit den gebäudebezogenen Daten (nur relevant zwischen Energieausweis-Berechnungssoftware und Druckapplikation),
				dem Block mit den anonymen Energieausweis-Daten sowie dem Block mit der Prüfsumme, die nach Erhalt und Eintragung der Registriernummer über den Block der anonymen Daten (ohne die gebäudebezogenen Daten!) gebildet wird.
			</xs:documentation>
		</xs:annotation>
		<xs:sequence>
			<xs:element name="Gebaeudebezogene-Daten" type="n1:Gebaeudebez-Daten" minOccurs="0" maxOccurs="1"/>
			<xs:element name="Energieausweis-Daten" type="n1:anonyme-GEG-Daten" minOccurs="1" maxOccurs="1"/>
		</xs:sequence>
	</xs:complexType>
	<xs:complexType name="Gebaeudebez-Daten">
		...
		<xs:sequence>
			...
			<xs:element name="Angaben-erhaeltlich" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Hinweis, wo genauere Angaben zu den Empfehlungen ggfs. erhältlich sind.
						Pflichtangabe, Default-Wert ist (wenn Modernisierungsempfehlungen möglich sind) die GEG-Infoseite des BBSR bzw. (wenn keine Modernisierungsempfehlungen möglich sind, z.B. nach Modernisierung oder bei Neubau) "Angabe hier nicht relevant", weitere / alternative Hinweise sind dem Energieausweis-Aussteller überlassen.
					</xs:documentation>
				</xs:annotation>
				<xs:simpleType>
					<xs:restriction base="xs:string">
			...
			<xs:element name="Ergaenzdende-Erlaeuterungen-EE" minOccurs="0" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Freitext-Platz für zusätzliche Erläuterungen zur Nutzung erneuerbaren Energien in der EA-Anhang.
					</xs:documentation>
				</xs:annotation>
				<xs:simpleType>
					<xs:restriction base="xs:string">
	...
	<xs:complexType name="anonyme-GEG-Daten">
		<xs:annotation>
			<xs:documentation xml:lang="DE">
				Block, der alle Daten für die Ausstellung des Energieausweises entsprechend GEG enthält, außer den dem Datenschutz unterliegenden und den freiwilligen Angaben. Nach Erhalt und Eintragung der Registriernummer muss dieser Block für die Kontrolle bereitgehalten werden.
			</xs:documentation>
		</xs:annotation>
		<xs:sequence>
			...
			<xs:element name="Gebaeudeteil" type="n1:Gebaeudeteil-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Ergänzende Angabe bei Wohnteilen oder Nichtwohnteilen von gemischt genutzten Gebäuden gemäß §79 Abs. 2 GEG; bei Einzelgebäude Angabe "Ganzes Gebäude".
						z.B. bei einem mehrgeschossigen Mehrfamilienhaus mit einer Ladenzeile im EG ist für die Hauptnutzung ein „WG-Energieausweis“ auszustellen und für den kleineren Teil der Ladenzeile ein Ausweis „NWG-Teil eines WG“.
						Bei dem Nichtwohnteil (Ausweis für NWG) des Wohngebäudes lautet dann die Auswahl „Teil des Wohngebäudes“.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			...
			<xs:element name="Altersklasse-Gebaeude" type="n1:Altersklasse-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Altersklasse-Waermeerzeuger" type="n1:Altersklasse-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Kuehlungsart-gelieferte-Kaelte" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:choice>
				<xs:element name="Keine-inspektionspflichtige-Anlage" type="xs:boolean" minOccurs="1" maxOccurs="1" fixed="true">
					<xs:annotation>
						<xs:documentation xml:lang="DE">
				...
				<xs:sequence>
					...
					<xs:element name="Anlage-groesser-12kW-ohneGA" type="xs:boolean" minOccurs="1" maxOccurs="1">
						<xs:annotation>
							<xs:documentation xml:lang="DE">
					...
					<xs:element name="Anlage-groesser-12kW-mitGA" type="xs:boolean" minOccurs="1" maxOccurs="1">
						<xs:annotation>
							<xs:documentation xml:lang="DE">
			...
			<xs:element name="Nutzung-zur-Erfuellung-von-EE-neue-Anlage" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Nutzung von Anlagen die zur Erfüllung der 65% EE-Regel gemäß § 71 Absatz 1 in Verbindung mit Absatz 2 oder Absatz 3 GEG für Warmasser und/oder Heizung, nur für neu eingebaute oder aufgestellte Heizungen relevant sind.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:element name="EE-Angabe-Warmwasser" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Nutzung der EE für Warmasser
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:element name="EE-Angabe-Heizung" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Nutzung der EE für Heizung
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:choice>
				<xs:element name="Keine-Pauschale-Erfuellungsoptionen-Anlagentyp" type="xs:boolean" minOccurs="1" maxOccurs="1" fixed="true">
					<xs:annotation>
						<xs:documentation xml:lang="DE">
				...
				<xs:sequence>
					<xs:element name="Hausuebergabestation" type="xs:boolean" minOccurs="1" maxOccurs="1">
						<xs:annotation>
							<xs:documentation xml:lang="DE">
					...
					<xs:element name="Waermepumpe" type="xs:boolean" minOccurs="1" maxOccurs="1">
						<xs:annotation>
							<xs:documentation xml:lang="DE">
								Wärmepumpe (§71 c)
							</xs:documentation>
					...
					<xs:element name="Stromdirektheizung" type="xs:boolean" minOccurs="1" maxOccurs="1">
						<xs:annotation>
							<xs:documentation xml:lang="DE">
					...
					<xs:element name="Solarthermische-Anlage" type="xs:boolean" minOccurs="1" maxOccurs="1">
						<xs:annotation>
							<xs:documentation xml:lang="DE">
					...
					<xs:element name="Heizungsanlage-Biomasse-Wasserstoff-Wasserstoffderivale" type="xs:boolean" minOccurs="1" maxOccurs="1">
						<xs:annotation>
							<xs:documentation xml:lang="DE">
								Heizungsanlage für Biomasse, grünen oder blauen Wasserstoff oder Wasserstoffderivale (§71f,g)
							</xs:documentation>
						</xs:annotation>
					</xs:element>
					<xs:element name="Waermepumpen-Hybridheizung" type="xs:boolean" minOccurs="1" maxOccurs="1">
						<xs:annotation>
							<xs:documentation xml:lang="DE">
					...
					<xs:element name="Solarthermie-Hybridheizung" type="xs:boolean" minOccurs="1" maxOccurs="1">
						<xs:annotation>
							<xs:documentation xml:lang="DE">
					...
					<xs:element name="Dezentral-elektrische-Warmwasserbereitung" type="xs:boolean" minOccurs="1" maxOccurs="1">
						<xs:annotation>
							<xs:documentation xml:lang="DE">
								Dezentral-elektrische Warmwasserbereitung (§71 Abs. 5)
							</xs:documentation>
						</xs:annotation>
					</xs:element>
				</xs:sequence>
			</xs:choice>
			<xs:element name="Nutzung-bei-Bestandsanlagen" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Nutzung bei Bestandsanlagen oder bei Übergangsregulierungen oder sonstige Ausnahmen. Die Anforderungen des § 71 (EE 65%) treffen nicht zu (Bestand).
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			...
			<xs:choice>
				<xs:element name="Keine-Modernisierung-Erweiterung-Vorhaben" type="xs:boolean" minOccurs="1" maxOccurs="1">
					<xs:annotation>
						<xs:documentation xml:lang="DE">
				...
				<xs:element name="Modernisierung-Erweiterung-anzeigepflichtiges-Vorhaben" type="xs:boolean" minOccurs="1" maxOccurs="1">
					<xs:annotation>
						<xs:documentation xml:lang="DE">
				...
				<xs:element name="Modernisierung-Erweiterung-genehmigungspflichtiges-Vorhaben" type="xs:boolean" minOccurs="1" maxOccurs="1">
					<xs:annotation>
						<xs:documentation xml:lang="DE">
							Austellungsanlass Modernisierung (140% Nachweis) nach § 50 (1).
						</xs:documentation>
			...
			<xs:element name="Modernisierungsempfehlungen" type="n1:Modernisierungszeile" minOccurs="0" maxOccurs="30">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Die Modernisierungsempfehlungen - wenn entsprechend Tag "Empfehlungen-moeglich" welche angegeben werden, sind hier nach Bauteilen aufgelistet anzugeben.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
		...
		<xs:attribute name="Gesetzesgrundlage" type="n1:Gesetzesgrundlage-enum" use="required">
			<xs:annotation>
				<xs:documentation xml:lang="DE">
					Bezeichnet die Gesetzesgrundlage (z.B. GEG-Version), nach der Nachweis geführt wurde.
				</xs:documentation>
			</xs:annotation>
		</xs:attribute>
		<xs:attribute name="Rechtsstand" type="xs:date" use="required">
			<xs:annotation>
				<xs:documentation xml:lang="DE">
					Entsprechend der Angabe des Rechtsstand-Datums für entweder
					- den Bauantrag bei genehmigungspflichtigen Vorhaben (Ausstellungsanlässe Neubau und Modernisierung (über 140% Verbesserung der Endeenergie)) oder
					- die Bauanzeige bei anzeigepflichtigen Vorhaben (Ausstellungsanlässe Neubau und Modernisierung (bis 140% Verbesserung der Endenergie ) oder
					- den Baubeginn (Ausstellungsanlass Modernisierung) oder
					- bei Wunsch des Bauherrn das neue Recht für alle oben genannten Fälle anzuwenden, das Datum der Wunschäußerung bei der zuständigen Stelle oder
					- die Ausweisausstellung (bei Verbrauchsausweisen und alle anderen Fälle).
				</xs:documentation>
			</xs:annotation>
		</xs:attribute>
	...
	<xs:simpleType name="Gesetzesgrundlage-enum">
		<xs:restriction base="xs:string">
			<xs:enumeration value="GEG-2024"/>
		</xs:restriction>
	</xs:simpleType>
	<xs:simpleType name="Rechtsstand-Grund-enum">
		<xs:restriction base="xs:string">
			<xs:enumeration value="Bauantrag bei genehmigungspflichtigen Vorhaben (Ausstellungsanlässe Neubau und Modernisierung)"/>
			<xs:enumeration value="Bauanzeige bei anzeigepflichtigen Vorhaben (Ausstellungsanlässe Neubau und Modernisierung)"/>
	...
	<xs:complexType name="Wohngebaeude-Daten">
		<xs:annotation>
			<xs:documentation xml:lang="DE">
				Dieser Block enthält im Falle eines Wohngebäudes alle weiteren energetisch relevanten Daten.
			</xs:documentation>
		</xs:annotation>
		<xs:sequence>
			<xs:element name="Gebaeudetyp" type="n1:Gebaeudetyp-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Grundsätzlicher Gebäudetypus des Gebäudes bzw. Gebäudeteils; die Angaben EFH mit ELW und Zweifamilienhaus sind gleichwertig und
						können je nach ortsüblichem Gebrauch oder Bauhistorie usw. verwendet werden.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
	...
	<xs:complexType name="Wohngebaeude-Verbrauchs-Daten">
		...
		<xs:sequence>
			<xs:element name="Flaechenermittlung-AN-aus-Wohnflaeche" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Energietraeger" type="n1:Energietraeger-Daten" minOccurs="1" maxOccurs="8">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Jeweiliger Energieträger mit zugehörigen Verbrauchsdaten
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			...
			<xs:element name="Warmwasserzuschlag" type="n1:Warmwasserzuschlag-Daten" minOccurs="0" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						...
						in der Tabelle ist statt des Energieträgers das Wort "Warmwasserzuschlag" einzusetzen, die Felder Anteil Kälte, Anteil Heizung und Klimafaktor bleiben in dieser Zeile leer.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			...
			<xs:element name="Energieeffizienzklasse" type="n1:Energieeffizienzklasse-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
	...
	<xs:complexType name="Energietraeger-Daten">
		...
		<xs:sequence>
			<xs:choice>
				<xs:element name="Energietraeger-Verbrauch" type="n1:Energietraeger-Verbrauch-enum" minOccurs="1" maxOccurs="1">
					<xs:annotation>
						<xs:documentation xml:lang="DE">
	...
	<xs:simpleType name="Energietraeger-Verbrauch-enum">
		<xs:restriction base="xs:string">
			...
			<xs:enumeration value="Nah-/Fernwärme aus KWK, fossiler Brennstoff (Stein-/Braunkohle) bzw. Energieträger in kWh"/>
			<xs:enumeration value="Nah-/Fernwärme aus KWK, fossiler Brennstoff (Gasförmige und flüssige Brennstoffe) bzw. Energieträger in kWh"/>
			<xs:enumeration value="Nah-/Fernwärme aus KWK, erneuerbarer Brennstoff bzw. Energieträger in kWh"/>
			<xs:enumeration value="Nah-/Fernwärme aus Heizwerken, fossiler Brennstoff (Stein-/Braunkohle) bzw. Energieträger in kWh"/>
			<xs:enumeration value="Nah-/Fernwärme aus Heizwerken, fossiler Brennstoff (Gasförmige und flüssige Brennstoffe) bzw. Energieträger in kWh"/>
			<xs:enumeration value="Nah-/Fernwärme aus Heizwerken, erneuerbarer Brennstoff bzw. Energieträger in kWh"/>
		</xs:restriction>
	</xs:simpleType>
	<xs:complexType name="Zeitraum-Daten">
		...
		<xs:sequence>
			...
			<xs:element name="Warmwasserwertermittlung" type="n1:Warmwasserwertermittlung-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Art, wie der Warmwasserwert ggfs. aus Messungen oder Berechnungen ermittelt wurde. Bei dezentraler Warmwasserbereitung in Wohngebäuden ist die Auswahl "Pauschale für dezentrale..." auszuwählen und das entsprechende Korrekturverfahren anzuwenden (siehe Element Warmwasserzuschlag-Daten).
						Die Auswahl "keine Warmwasserbereitung enthalten" ist bei Wohngebäuden zu wählen, wenn ein anderer ebenfalls gelisteter Energieträger die zentrale Warmwasserbereitung versorgt.
						Bei Nichtwohngebäuden ist sie zu wählen, wenn die Warmwasserbereitung im Stromverbrauch erfasst ist oder generell kein Warmwasser mit gebäudetechnischen Anlagen im Gebäude erzeugt wird.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:element name="Energieverbrauchsanteil-thermisch-erzeugte-Kaelte" minOccurs="0" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
	...
	<xs:complexType name="Leerstandszuschlag-Heizung-Daten">
		<xs:choice>
			...
			<xs:sequence>
				<xs:element name="Leerstandszuschlag-nach-Bekanntmachung" type="n1:Leerstandszuschlag-Bekanntmachung-Daten">
					<xs:annotation>
						<xs:documentation xml:lang="DE">
				...
				<xs:element name="Zuschlagsfaktor" minOccurs="1" maxOccurs="1">
					<xs:annotation>
						<xs:documentation xml:lang="DE">
							Wohngebäude: Zuschlagsfaktor f(eVhb, 12mth) nach der Formel f(eVhb, 12mth) = - 0,0028 * eVhb, 12mth + 0,9147
							Nichtwohngebäude: Zuschlagsfaktor f(eVhb, 12mth) nach der Formel f(eVhb, 12mth) = - 0,0083 * eVhb, 12mth + 1,3982
							gemäß GEG § 82 und gemeinsamen Bekanntmachung des Bundesministeriums für Wirtschaft und Energie und des Bundesministerium für Umwelt, Naturschutz, Bau und Reaktorsicherheit.
						</xs:documentation>
					</xs:annotation>
					<xs:simpleType>
						<xs:restriction base="xs:decimal">
				...
				<xs:element name="witterungsbereinigter-Endenergieverbrauchsanteil-fuer-Heizung" minOccurs="1" maxOccurs="1">
					<xs:annotation>
						<xs:documentation xml:lang="DE">
							Witterungsbereinigter Endenergieverbrauchsanteil für Heizung eVhb, 12mth ist Teil der Formel für Berechnung der Zuschlagsfaktor,
							Einheit in kWh/m²a; gemäß GEG § 82 und gemeinsamer Bekanntmachung des Bundesministeriums für Wirtschaft und Energie und des Bundesministerium für Umwelt, Naturschutz, Bau und Reaktorsicherheit.
						</xs:documentation>
					</xs:annotation>
					<xs:simpleType>
						<xs:restriction base="xs:decimal">
	...
	<xs:complexType name="Leerstandszuschlag-Warmwasser-Daten">
		<xs:sequence>
			<xs:element name="keine-Nutzung-von-WW" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						true: Warmwasser ist nicht vorhanden (nur bei NWG), oder dezentrale elektrische Warmwasserbereitung ist beim Stromanteil mit erfasst, die Leerstandskorrektur erfolgt in diesem Fall zusammen mit den übrigen elektrischen Verbrauchsanteilen.
						In diesem Fall ist "kein-Leerstand" anzugeben.
						false: Einer der anderen Fälle hat Gültigkeit (kein Leerstand oder Leerstand nach Bekanntmachung).
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:choice>
		...
		<xs:sequence>
			<xs:choice>
				<xs:element name="kein-Leerstand">
					...
					<xs:simpleType>
						<xs:restriction base="xs:string">
							<xs:pattern value="Kein längerer Leerstand thermisch erzeugte Kälte zu berücksichtigen."/>
						</xs:restriction>
					</xs:simpleType>
				</xs:element>
				<xs:element name="Leerstandszuschlag-nach-Bekanntmachung" type="n1:Leerstandszuschlag-Bekanntmachung-Daten">
	...
	<xs:complexType name="Leerstandszuschlag-Bekanntmachung-Daten">
		...
		<xs:sequence>
			...
			<xs:element name="Leerstandszuschlag-kWh" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Je nach Betrachtung von "Heizung", "Warmwasser", oder "Strom" bei NWG, ist der Leerstandszuschlag für den Energieverbrauchsanteil für:
						- Heizung in kWh: delta_E_Vh in der Tabelle in die Spalte "Anteil Heizung" einzusetzen
						- zentrale Warmwasserbereitung in kWh: delta_E_VWW in der Tabelle in die Spalte "Anteil Warmwasser" einzusetzen
						- Strom in kWh: delta_E_Vs in der Tabelle in die Spalte "Energieverbrauch Strom" einzusetzen
					</xs:documentation>
				</xs:annotation>
				<xs:simpleType>
					<xs:restriction base="xs:int">
	...
	<xs:complexType name="Wohngebaeude-Bedarfs-Daten-easy">
		...
		<xs:sequence>
			<xs:element name="Wohngebaeude-Anbaugrad" type="n1:Wohngebaeude-Anbaugrad-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Aufsummierte-Bruttogeschossflaeche" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Die aufsummierte Bruttogeschossfläche des Gebäudes über alle Geschosse (einschließlich Dachgeschoss,
						jedoch bei Gebäuden mit zwei oder mehr beheizten Geschossen werden nur 80% A_G des Dachgeschosses angerechnet,
			...
			<xs:element name="Dach-transparente-Bauteile-Fensterflaechenanteil" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Anforderung-Waermebruecken-erfuellt" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Die Wärmebrücken, die im Rahmen rechnerischer Nachweise zu berücksichtigen wären, sind so ausgeführt, dass sie mindestens gleichwertig zu den Musterlösungen nach DIN 4108 Beiblatt 2 sind.
						(§ 24 GEG über Fälle, in denen auf Gleichwertigkeitsnachweise verzichtet werden kann, bleibt unberührt)
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			...
			<xs:element name="Heiz-Warmwassersystem" type="n1:Heizwaermeerzeuger-Typ-easy-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Waermeschutz-Variante" type="n1:Waermeschutz-Variante-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Sommerlicher-Waermeschutz" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Das Gebäude erfüllt die Voraussetzungen, unter denen der sommerliche Wärmeschutz auch ohne rechnerischen Nachweis als erfüllt gilt (neue Normungsverweise).
						aa) Beim kritischen Raum (Raum mit der höchsten Wärmeeinstrahlung im Sommer) beträgt der
						Fensterflächenanteil bezogen auf die Grundfläche dieses Raums nicht mehr als 35 vom Hundert,
						bb) sämtliche Fenster in Ost-, Süd- oder Westorientierung (inkl. derer eines eventuellen
						Glasvorbaus) sind mit außenliegenden Sonnenschutzvorrichtun-gen mit einem
			...
			<xs:element name="Art-der-Nutzung-erneuerbaren-Energie-1" type="n1:Art-der-Nutzung-erneuerbaren-Energie-enum" minOccurs="0" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Anteil-der-Pflichterfuellung-1" minOccurs="0" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Pflichterfüllungsanteil in % für die erste Angabe zur Nutzung erneuerbarer Energien nach GEG.
						(§ 34: Die prozentualen Anteile der tatsächlichen Nutzung der einzelnen Maßnahmen im Verhältnis
						der jeweils nach den § 35 bis § 45 vorgesehenen Nutzung müssen in der Summe mindestens 100 Prozent Erfüllungsgrad ergeben.)
					</xs:documentation>
				</xs:annotation>
				<xs:simpleType>
					<xs:restriction base="xs:int">
			...
			<xs:element name="Art-der-Nutzung-erneuerbaren-Energie-2" type="n1:Art-der-Nutzung-erneuerbaren-Energie-enum" minOccurs="0" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Anteil-der-Pflichterfuellung-2" minOccurs="0" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Pflichterfüllungsanteil in % für die zweite Angabe zur Nutzung erneuerbarer Energien nach GEG.
						(§ 34: Die prozentualen Anteile der tatsächlichen Nutzung der einzelnen Maßnahmen im Verhältnis
						der jeweils nach den § 35 bis § 45 vorgesehenen Nutzung müssen in der Summe mindestens 100 Prozent Erfüllungsgrad ergeben.)
					</xs:documentation>
				</xs:annotation>
	...
	<xs:simpleType name="Heizwaermeerzeuger-Typ-easy-enum">
		<xs:restriction base="xs:string">
			<xs:enumeration value="Zentrale Biomasse-Heizungsanlage auf Basis von Holzpellets, Hackschnitzeln oder Scheitholz, zentrale Abluftanlage, solarthermische Anlage zur Trinkwarmwasser-Bereitung"/>
			<xs:enumeration value="Zentrale Biomasse-Heizungsanlage auf Basis von Holzpellets, Hackschnitzeln oder Scheitholz, Lüftungsanlage mit Wärmerückgewinnung, solarthermische Anlage zur Trinkwarmwasser-Bereitung"/>
			<xs:enumeration value="Fernwärme mit zertifiziertem Primärenergiefaktor fp ≤ 0,7, zentrale Lüftungsanlage mit Wärmerückgewinnung (Wärmebereitstellungsgrad ≥ 80 %)"/>
			<xs:enumeration value="Fernwärme mit zertifiziertem Primärenergiefaktor fp ≤ 0,7, zentrale Lüftungsanlage mit Wärmerückgewinnung (Wärmebereitstellungsgrad ≥ 80 %), solarthermische Anlagen"/>
			<xs:enumeration value="Fernwärme mit zertifiziertem Primärenergiefaktor fp ≤ 0,7, zentrale Lüftungsanlage mit Wärmerückgewinnung (Wärmebereitstellungsgrad ≥ 80 %), Photovoltaik-Anlagen"/>
			<xs:enumeration value="Luft-Wasser-Wärmepumpe, dezentrale Trinkwassererwärmung, Lüftungsanlage mit Wärmerückgewinnung (Wärmebereitstellungsgrad ≥ 80 %)"/>
			<xs:enumeration value="Luft-Wasser-Wärmepumpe mit Flächenheizsystem zur Wärmeübergabe, zentrale Lüftungsanlage mit Wärmerückgewinnung (Wärmebereitstellungsgrad ≥ 80 %)"/>
			<xs:enumeration value="Luft-Wasser-Wärmepumpe mit Flächenheizsystem zur Wärmeübergabe, Lüftungsanlage mit Wärmerückgewinnung (Wärmebereitstellungsgrad ≥ 80 %), solarthermische Anlagen"/>
			<xs:enumeration value="Luft-Wasser-Wärmepumpe mit Flächenheizsystem zur Wärmeübergabe, Lüftungsanlage mit Wärmerückgewinnung (Wärmebereitstellungsgrad ≥ 80 %), Photovoltaik-Anlagen"/>
			<xs:enumeration value="Wasser-Wasser-Wärmepumpe mit Flächenheizsystem zur Wärmeübergabe, zentrale Abluftanlage"/>
			<xs:enumeration value="Wasser-Wasser-Wärmepumpe mit Flächenheizsystem zur Wärmeübergabe, zentrale Abluftanlage, solarthermische Anlagen"/>
			<xs:enumeration value="Wasser-Wasser-Wärmepumpe mit Flächenheizsystem zur Wärmeübergabe, zentrale Abluftanlage, Photovoltaik-Anlagen"/>
			<xs:enumeration value="Wasser-Wasser-Wärmepumpe mit Flächenheizsystem zur Wärmeübergabe,  Lüftungsanlage mit Wärmerückgewinnung"/>
			<xs:enumeration value="Wasser-Wasser-Wärmepumpe mit Flächenheizsystem zur Wärmeübergabe,  Lüftungsanlage mit Wärmerückgewinnung, solarthermische Anlagen"/>
			<xs:enumeration value="Wasser-Wasser-Wärmepumpe mit Flächenheizsystem zur Wärmeübergabe,  Lüftungsanlage mit Wärmerückgewinnung, Photovoltaik-Anlagen"/>
			<xs:enumeration value="Sole-Wasser-Wärmepumpe mit Flächenheizsystem zur Wärmeübergabe, zentrale Abluftanlage"/>
			<xs:enumeration value="Sole-Wasser-Wärmepumpe mit Flächenheizsystem zur Wärmeübergabe, zentrale Abluftanlage, solarthermische Anlagen"/>
			<xs:enumeration value="Sole-Wasser-Wärmepumpe mit Flächenheizsystem zur Wärmeübergabe, zentrale Abluftanlage, Photovoltaik-Anlagen"/>
			<xs:enumeration value="Sole-Wasser-Wärmepumpe mit Flächenheizsystem zur Wärmeübergabe, Lüftungsanlage mit Wärmerückgewinnung"/>
			<xs:enumeration value="Sole-Wasser-Wärmepumpe mit Flächenheizsystem zur Wärmeübergabe, Lüftungsanlage mit Wärmerückgewinnung, solarthermische Anlagen"/>
			<xs:enumeration value="Sole-Wasser-Wärmepumpe mit Flächenheizsystem zur Wärmeübergabe, Lüftungsanlage mit Wärmerückgewinnung, Photovoltaik-Anlagen"/>
		</xs:restriction>
	</xs:simpleType>
	...
	<xs:complexType name="Heizungsanlage-Daten">
		<xs:annotation>
			<xs:documentation xml:lang="DE">
				Angaben zum jeweiligen Wärmeerzeuger
			</xs:documentation>
		</xs:annotation>
		<xs:sequence>
			<xs:element name="Waermeerzeuger-Bauweise-18599" type="n1:Heizwaermeerzeuger-Typ-18599-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Dieser Block enthält die Beizeichung für die Waermeerzeuger Bauweise nach DIN V 18599.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
	...
	<xs:simpleType name="Heizwaermeerzeuger-Typ-18599-enum">
		<xs:annotation>
			<xs:documentation xml:lang="DE">
				Geräte-Grundtyp des Wärmeerzeugers nach DIN V 18599 ergänzt um §71 GEG 2024. Die Anforderungen nach §71 (3) sind zu berücksichtigen.
			</xs:documentation>
		</xs:annotation>
		<xs:restriction base="xs:string">
			<xs:enumeration value="Standard-Heizkessel als Umstell-/Wechselbrandkessel"/>
			<xs:enumeration value="Standard-Heizkessel als Feststoffkessel (fossiler und biogener Brennstoff)"/>
			<xs:enumeration value="Standard-Heizkessel als Gas-Spezial-Heizkessel"/>
			<xs:enumeration value="Standard-Heizkessel als Gebläsekessel (fossiler und biogener Brennstoff)"/>
			...
			<xs:enumeration value="Solaranlagen zur Trinkwassererwärmung und Heizungsunterstützung (Solare Kombianlagen)"/>
			<xs:enumeration value="Hausübergabestation zum Anschluss an ein Wärmenetz"/>
			<xs:enumeration value="Solarthermische Anlage"/>
			<xs:enumeration value="Heizungsanlage zur Nutzung von Biomasse"/>
			<xs:enumeration value="Heizungsanlage zur Nutzung von grünem Wasserstoff"/>
			<xs:enumeration value="Heizungsanlage zur Nutzung von blauem Wasserstoff"/>
			<xs:enumeration value="Wärmepumpen-Hybridheizung aus elektrisch angetriebenen Wärmepumpe in Kombination mit einer Gasbrennstofffeuerung"/>
			<xs:enumeration value="Wärmepumpen-Hybridheizung aus elektrisch angetriebenen Wärmepumpe in Kombination mit einer Biomassebrennstofffeuerung"/>
			<xs:enumeration value="Wärmepumpen-Hybridheizung aus elektrisch angetriebenen Wärmepumpe in Kombination mit einer Flüssigbrennstofffeuerung"/>
			<xs:enumeration value="Solarthermie-Hybridheizung aus solarthermischen Anlage in Kombination mit einer Gasbrennstofffeuerung"/>
			<xs:enumeration value="Solarthermie-Hybridheizung bestehend aus einer solarthermischen Anlage in Kombination mit einer Biomassebrennstofffeuerung"/>
			<xs:enumeration value="Solarthermie-Hybridheizung bestehend aus einer solarthermischen Anlage in Kombination mit Flüssigbrennstofffeuerung"/>
		</xs:restriction>
	</xs:simpleType>
	<xs:simpleType name="Energietraeger-enum">
		<xs:restriction base="xs:string">
			...
			<xs:enumeration value="Nah-/Fernwärme aus KWK, fossiler Brennstoff (Stein-/Braunkohle) bzw. Energieträger"/>
			<xs:enumeration value="Nah-/Fernwärme aus KWK, fossiler Brennstoff (Gasförmige und flüssige Brennstoffe) bzw. Energieträger"/>
			<xs:enumeration value="Nah-/Fernwärme aus KWK, erneuerbarer Brennstoff bzw. Energieträger"/>
			<xs:enumeration value="Nah-/Fernwärme aus Heizwerken, fossiler Brennstoff (Stein-/Braunkohle) bzw. Energieträger"/>
			<xs:enumeration value="Nah-/Fernwärme aus Heizwerken, fossiler Brennstoff (Gasförmige und flüssige Brennstoffe) bzw. Energieträger"/>
			<xs:enumeration value="Nah-/Fernwärme aus Heizwerken, erneuerbarer Brennstoff bzw. Energieträger"/>
		</xs:restriction>
	</xs:simpleType>
	...
	<xs:complexType name="Trinkwarmwasseranlage-Daten">
		<xs:annotation>
			<xs:documentation xml:lang="DE">
				Angaben zum jeweiligen Warmwassererzeuger.
			</xs:documentation>
		</xs:annotation>
		<xs:sequence>
			<xs:element name="Trinkwarmwassererzeuger-Bauweise-18599" type="n1:Trinkwarmwassererzeuger-Typ-18599-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation>
						Dieser Block enthält die Bezeichung für die Wärmeerzeuger Bauweise nach DIN V 18599.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
	...
	<xs:complexType name="Wohngebaeude-Bedarfs-Daten-18599">
		...
		<xs:sequence>
			...
			<xs:element name="Bauteil-Transparent" type="n1:Bauteil-Transparent-Daten" minOccurs="0" maxOccurs="10000"/>
			...
			<xs:element name="Luftdichtheit" type="n1:Luftdichtheit-18599-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Interne-Waermequellen" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Summe der inneren Gewinne in kWh/a (Interne-Wärmequellen: Q_I,source)
						Info: Interne Wärmequellen nach DIN V 18599 berücksichtigen die ungeregelten Wärmequellen aus der Anlagentechnik nicht.
					</xs:documentation>
				</xs:annotation>
				<xs:simpleType>
					<xs:restriction base="xs:int">
			...
			<xs:element name="Heizsystem" type="n1:Heizungsanlage-Daten" minOccurs="1" maxOccurs="200">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Angaben zum / zu den Wärmeerzeuger(n); ist ein Gebäude ausschließlich passiv solar beheizt (Fenstereinstrahlung), ist als Wärmeerzeuger "Sonstiges" anzugeben. Ein Hinweis im Erläuterungsfeld auf Seite 4 des Energieausweises ist für diesen Fall zu empfehlen.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			...
			<xs:element name="Auslegungstemperatur" type="n1:Heizkreisauslegungstemperatur-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Warmwasserbereitungssystem" type="n1:Trinkwarmwasseranlage-Daten" minOccurs="1" maxOccurs="200">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Angaben zu dem / den Warmwassererzeuger(n).
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			...
			<xs:element name="Trinkwarmwasserverteilung-Zirkulation" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="spezifischer-Transmissionswaermetransferkoeffizient-Ist" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="spezifischer-Transmissionswaermetransferkoeffizient-Hoechstwert" minOccurs="0" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Innovationsklausel" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Angabe ob Innovationsklausel gemäß § 103 (1) GEG 2020 angewendet wurde.
						(Alternative Anforderungen: Treibhausgasemissionen, Höchstwert der Endenergiebedarfs + Transmissionswärmeverlust (nur für Neubau und WG) +
						Wärmedurchgangskoeffizienten der wärmeübertragenden Umfassungsfläche (nur für Neubau und NWG) - Aussetzung der Hauptanforderungen (Neubau § 10, Bestand § 50))
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			...
			<xs:element name="Primaerenergiebedarf-Hoechstwert-Bestand" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Primärenergie-Anforderungswert Modernisierter Altbau in kWh/m²a bezogen auf die energetische Nutzfläche, nur bei Ausstellungsanlass Modernisierung.
						Wenn entsprechend dem Ausstellungsanlass kein Wert zu übermitteln ist, kann eine 0 eingetragen werden, da dieser Wert dann nicht relevant ist.
					</xs:documentation>
				</xs:annotation>
				<xs:simpleType>
					<xs:restriction base="xs:decimal">
			...
			<xs:choice>
				<xs:sequence>
					<xs:element name="Endenergiebedarf-Hoechstwert-Bestand" minOccurs="1" maxOccurs="1">
						<xs:annotation>
							<xs:documentation xml:lang="DE">
								Endenergie-Anforderungswert Modernisierter Altbau in kWh/m²a bezogen auf die energetische Nutzfläche, nur bei Ausstellungsanlass Modernisierung.
								Wenn entsprechend dem Ausstellungsanlass kein Wert zu übermitteln ist, kann eine 0 eingetragen werden, da dieser Wert dann nicht relevant ist.
							</xs:documentation>
						</xs:annotation>
						<xs:simpleType>
					...
					<xs:element name="Treibhausgasemissionen-Hoechstwert-Bestand" minOccurs="1" maxOccurs="1">
						<xs:annotation>
							<xs:documentation xml:lang="DE">
								Anforderungswert für Treibhausgasemissionen Modernisierter Altbau in kg/m²a bezogen auf die energetische Nutzfläche, nur bei Ausstellungsanlass Modernisierung.
								Wenn entsprechend dem Ausstellungsanlass kein Wert zu übermitteln ist, kann eine 0 eingetragen werden, da dieser Wert dann nicht relevant ist.
							</xs:documentation>
						</xs:annotation>
						<xs:simpleType>
			...
			<xs:element name="Energietraeger-Liste" type="n1:Endenergie-Energietraeger-Daten" minOccurs="1" maxOccurs="10"/>
			...
			<xs:element name="Anteil-an-Waermeenergiebedarf-Berechnung" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Anteil am Wärmeenergiebedarf auf Grundlage von Berechnungen nach DIN V 18599:2018-09
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:element name="Weitere-Eintraege-und-Erlaeuterungen-in-der-Anlage" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Für weitere Einträge un Erläuterungen in der Anlage.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:element name="Angaben-erneuerbare-Energien-65EE-Regel" type="n1:Angaben-erneuerbare-Energien-65EE-Regel-Daten" minOccurs="0" maxOccurs="100"/>
			<xs:element name="Angaben-erneuerbare-Energien-keine-65EE-Regel" type="n1:Angaben-erneuerbare-Energien-Daten" minOccurs="0" maxOccurs="100"/>
			<xs:element name="spezifischer-Transmissionswaermetransferkoeffizient-verschaerft" minOccurs="0" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Treibhausgasemissionen-Zusaetzliche-Verbrauchsdaten" minOccurs="0" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Zusaetzliche-Verbrauchsdaten" type="n1:Wohngebaeude-Verbrauchs-Daten" minOccurs="0" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Bei Energieausweisen auf Bedarfsbasis können neben den Bedarfsangaben zusätzlich Angaben zum Verbrauch im Energieausweis dargestellt werden, die dann hier entsprechend integriert werden.
						Die Ermittlung der Fläche AN aus der Wohnfläche darf in den Wohngebäude-Verbrauchs-Daten dann nicht angekreuzt sein, da die Fläche nach einem für Bedarfsausweise zulässigen Verfahren ermittelt worden sein muss.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
		</xs:sequence>
	...
	<xs:complexType name="Nichtwohngebaeude-Daten">
		<xs:annotation>
			<xs:documentation xml:lang="DE">
				Dieser Block enthält im Falle eines Nichtwohngebäudes alle weiteren energetisch relevanten Daten.
			</xs:documentation>
		</xs:annotation>
		<xs:sequence>
			<xs:element name="Hauptnutzung-Gebaeudekategorie" type="n1:Nutzung-Gebaeudekategorie-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Pflichtangabe der Hauptnutzungsart des Gebäudes.
						Die Auswahl der Hauptnutzung-Gebaeudekategorie ergibt sich aus der "Bekanntmachung der Regeln für Energieverbrauchswerte und der Vergleichswerte im Nichtwohngebäudebestand"
						unter der Anlage 1 Tabelle 1 Teilenergiekennwerte (TEK) nach Gebäudekategorien.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:element name="Hauptnutzung-Gebaeudekategorie-Sonstiges-Beschreibung" minOccurs="0" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Sollte keine der 52 Gebäudekategorien laut Bekanntmachung für die Hauptnutzung zutreffend sein, muss in Hauptnutzung-Gebaeudekategorie-Sonstiges-Beschreibung eine alternative Bezeichnung eingetragen werden.
						Für die Seite 3 im Energieverbrauchsausweis Nichtwohngebäude darf die Gebäudekategorie '53:Sonstiges' nicht verwendet werden.
					</xs:documentation>
				</xs:annotation>
				<xs:simpleType>
					<xs:restriction base="xs:string">
	...
	<xs:complexType name="Nichtwohngebaeude-Verbrauchs-Daten">
		...
		<xs:sequence>
			...
			<xs:element name="Strom-Daten">
				...
				<xs:complexType>
					<xs:sequence>
						<xs:element name="Stromverbrauch-enthaelt-Zusatzheizung" type="xs:boolean" minOccurs="1" maxOccurs="1">
							<xs:annotation>
								<xs:documentation xml:lang="DE">
						...
						<xs:element name="Stromverbrauch-enthaelt-Warmwasser" type="xs:boolean" minOccurs="1" maxOccurs="1">
							<xs:annotation>
								<xs:documentation xml:lang="DE">
						...
						<xs:element name="Stromverbrauch-enthaelt-Lueftung" type="xs:boolean" minOccurs="1" maxOccurs="1">
							<xs:annotation>
								<xs:documentation xml:lang="DE">
						...
						<xs:element name="Stromverbrauch-enthaelt-Beleuchtung" type="xs:boolean" minOccurs="1" maxOccurs="1">
							<xs:annotation>
								<xs:documentation xml:lang="DE">
						...
						<xs:element name="Stromverbrauch-enthaelt-Kuehlung" type="xs:boolean" minOccurs="1" maxOccurs="1">
							<xs:annotation>
								<xs:documentation xml:lang="DE">
						...
						<xs:element name="Stromverbrauch-enthaelt-Sonstiges" type="xs:boolean" minOccurs="1" maxOccurs="1">
							<xs:annotation>
								<xs:documentation xml:lang="DE">
						...
						<xs:element name="Zeitraum-Strom" type="n1:Zeitraum-Strom-Daten" minOccurs="1" maxOccurs="40"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			<xs:element name="Leerstandszuschlag-Heizung" type="n1:Leerstandszuschlag-Heizung-Daten">
			...
			<xs:element name="Leerstandszuschlag-thermisch-erzeugte-Kaelte" type="n1:Leerstandszuschlag-thermisch-erzeugte-Kaelte-Daten">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Im dem Energieausweis zugrunde liegenden Zeitraum ist Leerstand aufgetreten, es wurde eine Leerstandskorrektur entsprechend der Bekanntmachung der Regeln für Energieverbrauchskennwerte vorgenommen.
					</xs:documentation>
			...
			<xs:element name="Nutzung-Gebaeudekategorie" type="n1:Nutzung-Gebaeudekategorie-Daten" minOccurs="1" maxOccurs="5">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Angabe der Nutzung des Gebäudes in Reihenfolge ihres Anteils der Energiebezugsfläche.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
	...
	<xs:complexType name="Zeitraum-Strom-Daten">
		...
		<xs:sequence>
			...
			<xs:element name="Energieverbrauchsanteil-elektrisch-erzeugte-Kaelte" minOccurs="0" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
	...
	<xs:complexType name="Nutzung-Gebaeudekategorie-Daten">
		<xs:sequence>
			<xs:element name="Gebaeudekategorie" type="n1:Nutzung-Gebaeudekategorie-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Angabe der Nutzung des Gebäudes in Reihenfolge ihres Anteils der Energiebezugsfläche.
						Die Auswahl der Nutzung-Gebaeudekategorie ergibt sich aus der "Bekanntmachung der Regeln für Energieverbrauchswerte und der Vergleichswerte im Nichtwohngebäudebestand"
						unter der Anlage 1 Tabelle 1 Teilenergiekennwerte (TEK) nach Gebäudekategorien.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
	...
	<xs:simpleType name="Nutzung-Gebaeudekategorie-enum">
		<xs:restriction base="xs:string">
			...
			<xs:enumeration value="17:Krankenhäuser (ohne Forschung und Lehre) und teilstationäre Versorgung"/>
			...
			<xs:enumeration value="41:Gewerbliche und industrielle Gebäude - schwere Arbeit, stehende Tätigkeit"/>
			<xs:enumeration value="42:Gewerbliche und industrielle Gebäude - Mischung aus leichter u. schwerer Arbeit"/>
			<xs:enumeration value="43:Gewerbliche und industrielle Gebäude - leichte Arbeit, überwiegend sitzende Tätigkeit"/>
			...
			<xs:enumeration value="53:Sonstiges">
				<xs:annotation>
					<xs:documentation>
						Im Fall der Nutzung von '53:Sonstiges' ist dann auch das Feld 'Hauptnutzung-Gebaeudekategorie-Sonstiges-Beschreibung' zu befüllen.
						Für die Seite 3 im Energieverbrauchsausweis Nichtwohngebäude darf die Gebäudekategorie '53:Sonstiges' nicht verwendet werden.
					</xs:documentation>
				</xs:annotation>
			</xs:enumeration>
	...
	<xs:complexType name="Nichtwohngebaeude-Bedarfs-Daten">
		...
		<xs:sequence>
			<xs:element name="Bruttovolumen" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Konditioniertes brutto-Gebäudevolumen des Gebäudes/Gebäudeteils (ganze Kubikmeter) (Bruttovolumen: V_e)
						ggf. überschlägig ermittelter Wert.
					</xs:documentation>
				</xs:annotation>
				<xs:simpleType>
					<xs:restriction base="xs:int">
			...
			<xs:element name="Warmwasserbereitungssystem" type="n1:Trinkwarmwasseranlage-Daten" minOccurs="0" maxOccurs="50">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Warmwassererzeuger, bei mehreren sinnvollerweise nach abnehmender energetischer Relevanz.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:element name="Trinkwarmwasserspeicher-Nenninhalt" minOccurs="1" maxOccurs="1">
			...
			<xs:element name="Kaelteanlage" type="n1:Kaelteanlage-Daten" minOccurs="0" maxOccurs="30">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Kälteerzeuger, bei mehreren sinnvollerweise nach abnehmender energetischer Relevanz.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			...
			<xs:element name="RLT-System" type="n1:RLT-Anlagen-Daten" minOccurs="0" maxOccurs="100">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Angaben zu vorhandenen Lüftungsanlagen, bei mehreren sinnvollerweise nach abnehmender Relevanz.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:element name="Automatisierungsgrad" type="n1:Automatisierungsgrad-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Automatisierungsgrad-Technisches-Gebaeudemanagement" type="n1:Automatisierungsgrad-Technisches-Gebaeudemanagement-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Primaerenergiebedarf-Hoechstwert-Bestand" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Primärenergie-Anforderungswert Modernisierter Altbau in kWh/m²a bezogen auf die energetische Nutzfläche.
						Außerdem richtet sich die Länge der grün-rot-Skala nach diesem Wert (Skalenendewert das Dreifache des Wertes), daher ist der Wert immer erforderlich. (Primärenergiebedarf: Q_p,Ref)
					</xs:documentation>
				</xs:annotation>
				<xs:simpleType>
					<xs:restriction base="xs:decimal">
			...
			<xs:element name="Vereinfachungen-18599-1-D" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Wurden Vereinfachungen nach § 21 Absatz 2 GEG und DIN V 18599-1:2018-09 Anhang D angewendet?
						(auch für zu errichtende Nichtwohngebäude/ Neubau anwendbar)
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:element name="Anteil-an-Waermeenergiebedarf-Berechnung" type="xs:boolean" minOccurs="1" maxOccurs="1">
			...
			<xs:element name="Zusaetzliche-Verbrauchsdaten" type="n1:Nichtwohngebaeude-Verbrauchs-Daten" minOccurs="0" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Bei Energieausweisen auf Bedarfsbasis können neben den Bedarfsangaben zusätzlich Angaben zum Verbrauch im Energieausweis dargestellt werden, die dann hier entsprechend integriert werden.
					</xs:documentation>
	...
	<xs:simpleType name="Art-der-Nutzung-erneuerbaren-Energie-enum">
		<xs:restriction base="xs:string">
			...
			<xs:enumeration value="Fernwärme"/>
			<xs:enumeration value="grüner Wasserstoff"/>
			<xs:enumeration value="blauer Wasserstoff"/>
	...
	<xs:complexType name="Bauteil-Opak-Daten">
		<xs:annotation>
			<xs:documentation xml:lang="DE">
				Dieser Block enthält im Falle eines Bedarfsausweises die Hüllflächendaten.
				Die Summe aller Flächen muss der gesamten energetisch wirksamen Hüllfläche entsprechen.
				Wand- und Dachflächen gegen Aussenluft sind daher netto ohne transparente Bauteile usw. anzugeben.
				Gleichartige Flächen gleichen U-Wertes und gleicher Orientierung können aufsummiert angegeben werden.
				Türen (ausser Fenstertüren), Rollladenkästen u.ä. sind als Wandstücke einzugeben.
			</xs:documentation>
		</xs:annotation>
		<xs:sequence>
			...
			<xs:element name="Glasdach-Lichtband-Lichtkuppel" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
	...
	<xs:complexType name="Kaelteanlage-Daten">
		...
		<xs:sequence>
			<xs:element name="Kaelteerzeuger-Bauweise" type="n1:Kaelteerzeuger-Typ-enum" minOccurs="1" maxOccurs="1"/>
			<xs:element name="Kaelteerzeuger-Regelung" type="n1:Kaelteerzeuger-Regelung-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Die Zuordnung bezieht sich auf die Art der Teillastregelung in DIN V 18599 Tab. 25, 27 und 29, z.B. auf die Formulierung
						"…regelung" = stufenlos regelnd
						"mehrstufig schaltbar" = mehrstufig taktend
						"stetige Regelung" = stufenlos regelnd
						"Zweipunktregelung" = ein-aus-Betrieb
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:element name="Rueckkuehlung-Bauweise" type="n1:Rueckkuehlung-enum" minOccurs="1" maxOccurs="1"/>
			<xs:element name="Kaelteverteilung-Primaerkreis-Temperatur" type="n1:Kaelte-Temperaturniveau-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
	...
	<xs:complexType name="Angaben-erneuerbare-Energien-65EE-Regel-Daten">
		<xs:annotation>
			<xs:documentation>
				Angaben zur Nutzung erneuerbare Energien bei Erfüllung der 65%-EE-Regel auf Grundlage einer Berechnung im Einzelfall nach §71 Absatz 2 GEG.
			</xs:documentation>
		</xs:annotation>
		<xs:sequence>
			<xs:element name="Waermeerzeuger-Bauweise-18599" type="n1:Heizwaermeerzeuger-Typ-18599-enum" minOccurs="1" maxOccurs="1">
			...
			<xs:element name="Art-der-Nutzung-erneuerbaren-Energie" type="n1:Art-der-Nutzung-erneuerbaren-Energie-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Es wird eine Angabe im Energieausweis zur Nutzung erneuerbarer Energien nach §71 ff GEG erwartet.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:element name="Deckungsanteil" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Anteil-der-Pflichterfuellung-Anlage" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Anteil EE an der Wärmebereitstellung der Einzelanlage.
					</xs:documentation>
				</xs:annotation>
				<xs:simpleType>
					<xs:restriction base="xs:int">
			...
			<xs:element name="Anteil-der-Pflichterfuellung-Gesamt" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Anteil EE an der Wärmebereitstellung aller Anlagen.
					</xs:documentation>
				</xs:annotation>
				<xs:simpleType>
					<xs:restriction base="xs:int">
	...
	<xs:complexType name="Angaben-erneuerbare-Energien-Daten">
		<xs:annotation>
			<xs:documentation>
				Angaben zur Nutzung erneuerbare Energien bei Anlagen, für die die 65%-EE-Regel nicht gilt. (Anlagen, die vor dem 1. Januar 2024 zum Zweck der Inbetriebname in einem Gebäude eingebaut oder aufgestellt worden sind oder einer Übergangsregelung nach §71 i-m GEG unterfallen, gemäß Berechnung im Einzelfall)
			</xs:documentation>
		</xs:annotation>
		<xs:sequence>
			<xs:element name="Waermeerzeuger-Bauweise-18599" type="n1:Heizwaermeerzeuger-Typ-18599-enum" minOccurs="1" maxOccurs="1">
			...
			<xs:element name="Art-der-Nutzung-erneuerbaren-Energie" type="n1:Art-der-Nutzung-erneuerbaren-Energie-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Es wird eine Angabe im Energieausweis zur Nutzung erneuerbarer Energien erwartet.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:element name="Anteil-EE-Anlage" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Anteil EE an der Wärmebereitstellung oder de, Wäme-/Kältebedarf
					</xs:documentation>
				</xs:annotation>
				<xs:simpleType>
					<xs:restriction base="xs:int">
	...
	<xs:complexType name="Zonen-Daten">
		...
		<xs:sequence>
			...
			<xs:element name="Sonnenschutz-System" type="n1:Sonnenschutz-enum" minOccurs="1" maxOccurs="50">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Sonnenschutz der transparenten Flächen nach außen.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:element name="Beleuchtungs-System" type="n1:Lampenart-enum" minOccurs="1" maxOccurs="50">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
						Überwiegende Beleuchtungstechnik (Kunstlicht) der jeweiligen Zone.
					</xs:documentation>
				</xs:annotation>
			</xs:element>
			<xs:element name="Beleuchtungs-Verteilung" type="n1:Beleuchtungsart-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Tageslichtabhaengige-Kontrollsysteme" type="xs:boolean" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
	...
	<xs:complexType name="Endenergie-Energietraeger-Daten">
		...
		<xs:sequence>
			<xs:element name="Energietraegerbezeichnung" type="n1:Energietraeger-enum" minOccurs="1" maxOccurs="1"/>
			<xs:element name="Primaerenergiefaktor" minOccurs="1" maxOccurs="1">
				<xs:simpleType>
					<xs:restriction base="xs:decimal">
						<xs:fractionDigits value="2"/>
			...
			<xs:element name="Endenergiebedarf-Kuehlung-Befeuchtung-spezifisch" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Endenergiebedarf-Energietraeger-Gesamtgebaeude-spezifisch" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
	...
	<xs:complexType name="NWG-Aushang-Daten">
		...
		<xs:sequence>
			...
			<xs:element name="Primaerenergiebedarf-Kuehlung-Befeuchtung-Diagramm" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
	...
	<xs:complexType name="Modernisierungszeile">
		...
		<xs:sequence>
			...
			<xs:element name="Bauteil-Anlagenteil" type="n1:Modernisierung-Teil-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
			...
			<xs:element name="Modernisierungskombination" type="n1:Modernisierung-Kombi-enum" minOccurs="1" maxOccurs="1">
				<xs:annotation>
					<xs:documentation xml:lang="DE">
